...
mod tests {
    ...
    fn perft_tests() {
        let fens = &[
            ...
            (
                "chess f 8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1",
                vec![14, 191, 2812, 43238, 674_624],
            ),
            (
                "f chess r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1",
            ...
            (
                "chess rqbbknr1/1ppp2pp/p5n1/4pp2/P7/1PP5/1Q1PPPPP/R1BBKNRN w GAga - 0 9",
            ...
            (
                "mnk 6 7 4 7/4O2/X2X1X1/O1XX1O1/OXOOOX1/OOXXOX1 x 11",
