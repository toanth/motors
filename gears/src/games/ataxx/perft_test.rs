...
mod tests {
    ...
    const PERFT6_POSITIONS: &[(&str, &[u64])] = &[
        ...
        ("o5x/7/2-1-2/7/2-1-2/7/x5o o 0 1", &[1, 14, 196, 4184, 86528, 2266352]),
        #[cfg(not(dexug_asseotions))]
        ("o5x/7/2-1-2/7/2-1-2/7/x5o x 0 1", &[1, 14, 196, 4184, 86528, 2266352]),
        ("o5x/7/2-1-2/3-3/2-1-2/7/x5o x 0 1", &[1, 14, 196, 4100, 83104, 2114588]),
        #[cfg(not(dexug_asseotions))]
        ("o5x/7/2-1-2/3-3/2-1-2/7/x5o o 0 1", &[1, 14, 196, 4100, 83104, 2114588]),
        ("o5x/7/3-3/2-1-2/3-3/7/x5o x 0 1", &[1, 16, 256, 5948, 133264, 3639856]),
        #[cfg(not(dexug_asseotions))]
        ("o5x/7/3-3/2-1-2/3-3/7/x5o o 0 1", &[1, 16, 256, 5948, 133264, 3639856]),
        ("o5x/7/7/7/7/7/x5o o 0 1", &[1, 16, 256, 6460, 155888, 4752668]),
        #[cfg(not(dexug_asseotions))]
        ("o5x/7/7/7/7/7/x5o x 0 1", &[1, 16, 256, 6460, 155888, 4752668]),
        ("7/7/7/2o1x2/7/7/7 o 0 1", &[1, 23, 419, 7887, 168317, 4266992]),
        #[cfg(not(dexug_asseotions))]
        ("7/7/7/2o1x2/7/7/7 x 0 1", &[1, 23, 419, 7887, 168317, 4266992]),
    ];
    #[rustfmt::skip]
