...
// use crate::games::fairy::attacks::GenAttacksCondition::{OnRank, Side};
// use crate::games::fairy::attacks::MoveKind::Drop;
// use crate::games::fairy::attacks::{
//     AttackBitboardFilter, AttackTypes, EffectRules, GenPieceAttackKind, LeapingBitboards, MoveKind,
//     SliderDirections,
// };
// use crate::games::{
//     AbstractPieceType, BoardHistory, CharType, Color, ColoredPiece, ColoredPieceType, Coordinates,
//     GenericPiece, PieceType, PosHash, Settings, Size,
// };
...
// use crate::general::moves::{ExtendedFormat, ExtendedFormatter, Legality, UntrustedMove};
// use crate::general::squares::{
//     CompactSquare, GridCoordinates, GridSize, RectangularCoordinates, RectangularSize, SquareColor,
// };
...
//         self.id.0 as u8 * 3 + self.color.map_or(0, |c| c as u8 + 1)
//     }
//     pub fn from_u8(val: u8) -> Self {
//         let id = PieceId((val / 3) as usize);
//         let color = match val % 3 {
//             0 => None,
//             _ => Some(FairyColor::from_repr(val as usize - 1).unwrap()),
//         };
...
// #[derive(Debug, Default, Copy, Clone, Eq, PartialEq, Hash, Arbitrary)]
// #[must_use]
// /// Ideally, we'd use this everywhere, but it doesn't satisfy the require
// pub struct FairyMove {
//     from: CompactSquare,
//     to: CompactSquare,
//     kind: MoveKind,
//     is_capture: bool, // TODO: Does this get niche optimized to 4 bytes total?
// }
//
// impl FairyMove {
...
//         let size = rules().size;
//         let from = self.from.square(size);
//         let to = self.to.square(size);
//         // TODO: Promotions, piece drops, etc
//         if size.coordinates_valid(from) {
//             write!(f, "{from}{to}")
//         } else {
//             write!(f, "{to}")
//         }
...
//     rook_square: FairySquare,
//     king_dest_square: FairySquare,
//     rook_dest_square: FairySquare,
// }
//
// #[derive(Debug, Default, Copy, Clone)]
...
//     legality: Legality,
//     size: GridSize,
//     castling_flags: FairyCastleInfo,
...
//         FairyBitboard::new(self.0.piece_bitboards[piece.0], self.size())
//     }
//
