...
pub fn select_command<T: NamedEntity + ?Sized>(list: &[Box<T>]) -> CommandList {
    let mut res: CommandList = vec![];
    for entity in list {
...
fn options_options(ac: &dyn AutoCompleteState, accept_name_word: bool, only_name: bool) -> CommandList {
