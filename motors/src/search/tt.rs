...
impl<B: Board> TTEntry<B> {
    ...
    fn write(self, entry: &AtomicTTEntry) {
        ...
        if cfg!(feature = "unsafe") {
            ...
            let val = ((self.score as u16 as u64) << (64 - 16))
                | ((self.age.0 as u64) << 32)
...
mod test {
    ...
    #[cfg(feature = "chess")]
    fn test_load_store() {
        for (n, pos) in Chessboard::bench_positions().into_iter().enumerate() {
