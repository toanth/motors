...
spsa_params! [
    ...
    move_stability_min_depth: isize=18; 1..=25; step=2;
    move_stability_start_div: usize = 4; 1..=10; step=1;
    move_stability_factor: usize = 756; 250..=1000; step=50;
    soft_limit_fail_low_factor: usize = 1212; 1000..=3000; step=50;
    aw_exact_add: ScoreT = 6; 0..=42; step=2;
    aw_exact_div: ScoreT = 2; 1..=10; step=1;
    aw_delta_max: u32 = 13; 0..=40; step=2;
    aw_widening_factor: ScoreT = 2; 1..=10; step=1;
    they_blundered_threshold: ScoreT = 54; 0..=200; step=5;
    we_blundered_threshold: ScoreT = -51; -200..=0; step=5;
    iir_min_depth: isize = 4; 1..=15; step=1;
    rfp_base: ScoreT = 146; 0..=900; step=15;
    rfp_blunder: ScoreT = 60; 0..=512; step=8;
