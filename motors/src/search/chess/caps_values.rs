...
spsa_params![
    ...
    temp_tt_fail_low: i32 = -2048; 128..=8192; step=64;
    temp_tt_fail_high: i32 = 2048; 128..=8192; step=64;
    temp_tt_less_alpha: i32 = -2048; 128..=8192; step=64;
    temp_tt_greater_beta: i32 = 2048; 128..=8192; step=64;
    temp_they_blundered: i32 = 64; -1024..=4096; step=64;
    temp_we_blundered: i32 = -64; -4096..=1024; step=64;
    temp_rfp_fail_high: i32 = 0; -1024..=4096; step=64;
    temp_razoring_failed_high: i32 = 2048; 0..=4096; step=64;
    temp_nmp_threshold: i32 = 0; -2048..=4096; step=64;
    temp_nmp: i32 = -2048; -4096..=1024; step=64;
    temp_nmp_verif: i32 = 1024; -1024..=4096; step=64;
    temp_rfr: i32 = 1024; -1024..=4096; step=64;
    temp_lmp_threshold: i32 = 0; -4096..=2048; step=64;
    temp_se_scout_search: i32 = -1024; -4096..=1024; step=64;
    temp_first_child: i32 = 64; -1024..=2048; step=16;
    temp_later_child: i32 = 1024; -1024..=4096; step=64;
    temp_late_multiplier: i32 = 32; -128..=256; step=8;
    temp_do_deeper: i32 = -512; -4096..=2048; step=64;
    temp_pvs_research: i32 = -512; -4096..=2048; step=64;
    temp_second_research: i32 = 0; -1024..=1024; step=64;
    ...
    rfr_min_depth: isize = 6 * 128; 256..=2048; step=64;
    ...
    max_lmp_depth: isize = 6 * 128; 1..=16_384; step=64;
    ...
    retry_base_reduction: isize = 0; -64..=128; step=8;
    do_deeper_base: ScoreT = 50; 8..=256; step=4;
    do_deeper_val: isize = 128; 32..=256; step=8;
    do_shallower_base: ScoreT = 10; 2..=128; step=4;
    do_shallower_val: isize = 128; 32..=256; step=8;
    ...
    noisy_hist_depth_penalty: isize = 128; 4..=512; step=32;
    noisy_hist_penalty_offset: isize = 0; -256..=256; step=8;
    noisy_hist_penalty_eval_diff: u32 = 8; 0..=16; step=1;
    hist_depth_bonus: isize = 128; 4..=512; step=32;
    hist_bonus_offset: isize = 0; -256..=256; step=8;
    hist_bonus_eval_diff: u32 = 8; 0..=16; step=1;
    hist_depth_penalty: isize = 128; 4..=512; step=32;
    hist_penalty_offset: isize = 0; -256..=256; step=8;
    hist_penalty_eval_diff: u32 = 8; 0..=16; step=1;
    noisy_hist_depth_penalty_bm_quiet: isize = 128; 4..=512; step=32;
    noisy_hist_penalty_offset_bm_quiet: isize = 0; -256..=256; step=8;
    noisy_hist_penalty_eval_diff_bm_quiet: u32 = 8; 0..=16; step=1;
    ...
    temp_corrhist_update_clamp: isize = 256; 8..=2048; step=32;
