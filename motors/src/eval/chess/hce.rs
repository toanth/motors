...
#[rustfmt::skip]const PSQTS: [[i32; NUM_SQUARES]; NUM_CHESS_PIECES * 2] = [
    // pawn MG
    [
           0,    0,    0,    0,    0,    0,    0,    0,
    ...
    [
         ...
         269,  290,  322,  340,  318,  376,  291,  304,
    ...
    [
         ...
         368,  369,  371,  376,  384,  389,  423,  402,
    ...
    [
         ...
         838,  836,  844,  852,  870,  908,  904,  889,
         827,  835,  841,  842,  846,  855,  852,  861,
         832,  832,  836,  842,  842,  843,  854,  851,
         830,  842,  839,  839,  844,  850,  862,  853,
         828,  838,  847,  844,  844,  853,  860,  858,
         827,  820,  824,  839,  832,  822,  825,  828,
    ],
    // queen EG
    [
        1149, 1155, 1171, 1161, 1165, 1150, 1104, 1141,
        1117, 1153, 1182, 1200, 1212, 1173, 1153, 1128,
        1117, 1139, 1167, 1176, 1184, 1163, 1133, 1130,
        1126, 1146, 1160, 1181, 1193, 1180, 1170, 1144,
        1119, 1147, 1152, 1171, 1166, 1159, 1142, 1133,
        1107, 1119, 1141, 1138, 1138, 1130, 1109, 1100,
