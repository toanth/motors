...
const PASSED_PAWNS_MG: [i32; 64] = [
    0, 0, 0, 0, 0, 0, 0, 0, -18, -9, -17, -20, -5, -4, 2, -4, -10, -23, -24, -19, -19, -15, -24, 2,
    -3, -13, -19, -12, -19, -10, -26, -16, 12, 8, 18, 17, 0, 5, -23, -18, 33, 42, 33, 19, 18, 8,
    -32, -51, 21, 16, 20, 20, 12, 9, -8, 1, 0, 0, 0, 0, 0, 0, 0, 0,
];
// passed pawns eg
const PASSED_PAWNS_EG: [i32; 64] = [
    0, 0, 0, 0, 0, 0, 0, 0, 3, 5, 15, 10, -1, 4, 6, 6, 0, 7, 12, 2, 8, 9, 21, 5, 31, 28, 26, 19,
    22, 25, 39, 37, 57, 54, 45, 37, 39, 45, 61, 63, 109, 107, 94, 64, 68, 90, 97, 117, -14, -13,
    -11, -12, -5, -7, -7, -9, 0, 0, 0, 0, 0, 0, 0, 0,
];
