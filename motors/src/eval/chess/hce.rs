...
const PSQTS: [[i32; NUM_SQUARES]; NUM_CHESS_PIECES * 2] = [
    ...
    // knight mg
    [
         149,  195,  241,  273,  317,  224,  231,  192,
         278,  300,  334,  349,  334,  391,  304,  316,
         299,  337,  358,  370,  404,  412,  359,  326,
         ...
         220,  263,  252,  267,  274,  290,  268,  244,
    ],
    // knight eg
    [
         266,  323,  342,  330,  328,  324,  320,  246,
         317,  335,  338,  339,  335,  319,  329,  304,
         ...
         314,  332,  337,  340,  339,  333,  321,  322,
         302,  294,  322,  326,  325,  313,  300,  297,
    ],
    // bishop mg
    [
         303,  283,  288,  262,  270,  272,  317,  286,
         320,  348,  344,  326,  352,  349,  342,  317,
         ...
         312,  335,  318,  309,  314,  314,  338,  323,
    ],
    // bishop eg
    [
         347,  359,  355,  365,  361,  355,  351,  346,
    ...
    // rook mg
    [
         435,  424,  430,  436,  449,  458,  467,  479,
    ...
    // queen mg
    [
         826,  844,  868,  898,  893,  914,  944,  879,
         858,  841,  851,  845,  851,  889,  875,  912,
         ...
         852,  862,  871,  871,  869,  879,  886,  888,
         853,  844,  850,  865,  857,  846,  858,  857,
    ],
    // queen eg
    [
        1185, 1194, 1208, 1197, 1203, 1186, 1142, 1177,
        1155, 1193, 1222, 1239, 1254, 1214, 1197, 1169,
        1154, 1178, 1207, 1215, 1223, 1204, 1171, 1166,
        1164, 1188, 1202, 1222, 1234, 1220, 1208, 1183,
        1155, 1187, 1191, 1213, 1205, 1201, 1184, 1172,
        1148, 1158, 1180, 1178, 1180, 1172, 1153, 1141,
        1144, 1143, 1138, 1146, 1149, 1123, 1099, 1079,
        1132, 1139, 1145, 1134, 1137, 1129, 1115, 1116,
    ],
    // king mg
    [
        -161, -147, -137, -166, -159, -160, -157, -167,
        -157, -118, -122,  -96, -110, -124, -113, -140,
        -119,  -43,  -72,  -82,  -59,  -26,  -46,  -84,
         -78,  -69,  -81, -101, -101,  -80,  -88,  -98,
         -78,  -69,  -94, -109, -111,  -97, -100, -117,
         -48,  -26,  -72,  -77,  -70,  -78,  -41,  -57,
          39,    7,   -9,  -39,  -43,  -20,   18,   24,
          26,   59,   36,  -55,    7,  -43,   39,   36,
    ],
    // king eg
    [
        -111,  -51,  -44,   -9,  -25,  -16,  -20, -110,
         -23,    7,   15,    1,   14,   29,   20,  -16,
         -10,   11,   27,   38,   32,   30,   29,   -1,
         -17,   16,   34,   45,   46,   38,   31,    2,
         -21,    7,   28,   43,   41,   28,   15,   -2,
