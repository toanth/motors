...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( 135,  189),    p( 131,  188),    p( 124,  192),    p( 135,  175),    p( 121,  179),    p( 119,  183),    p(  79,  199),    p(  83,  199),
        p(  71,  121),    p(  73,  124),    p(  81,  115),    p(  89,  116),    p(  86,  116),    p( 128,  105),    p( 106,  125),    p(  97,  117),
        p(  54,  111),    p(  65,  105),    p(  63,  101),    p(  85,   99),    p(  92,   99),    p(  86,   89),    p(  79,  100),    p(  74,   93),
        p(  48,   98),    p(  54,  101),    p(  78,   93),    p(  93,   96),    p(  92,   98),    p(  86,   95),    p(  69,   91),    p(  62,   84),
        p(  43,   96),    p(  53,   92),    p(  72,   96),    p(  83,   97),    p(  85,   95),    p(  81,   94),    p(  81,   81),    p(  64,   81),
        p(  55,  100),    p(  62,   99),    p(  65,   98),    p(  62,  104),    p(  67,  107),    p(  82,   98),    p(  90,   86),    p(  60,   87),
        p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),
    ],
    // knight
    [
        p( 175,  279),    p( 196,  312),    p( 212,  325),    p( 252,  313),    p( 281,  316),    p( 198,  310),    p( 214,  310),    p( 202,  263),
        ...
        p( 299,  317),    p( 305,  306),    p( 314,  312),    p( 321,  315),    p( 320,  318),    p( 325,  303),    p( 323,  304),    p( 312,  313),
        p( 275,  303),    p( 283,  302),    p( 297,  297),    p( 302,  309),    p( 306,  307),    p( 296,  291),    p( 302,  294),    p( 295,  307),
        p( 270,  310),    p( 281,  314),    p( 285,  304),    p( 295,  309),    p( 299,  304),    p( 289,  303),    p( 296,  307),    p( 289,  323),
        p( 240,  307),    p( 281,  304),    p( 267,  307),    p( 288,  311),    p( 295,  309),    p( 293,  299),    p( 289,  308),    p( 267,  309),
    ],
    // bishop
    [
        p( 277,  311),    p( 252,  315),    p( 238,  308),    p( 221,  319),    p( 214,  317),    p( 225,  309),    p( 271,  305),    p( 249,  311),
        p( 283,  303),    p( 280,  304),    p( 290,  308),    p( 277,  306),    p( 287,  303),    p( 290,  302),    p( 267,  309),    p( 266,  305),
        ...
        p( 290,  306),    p( 285,  308),    p( 295,  303),    p( 309,  303),    p( 302,  300),    p( 300,  302),    p( 286,  305),    p( 309,  300),
        p( 296,  307),    p( 300,  303),    p( 300,  305),    p( 299,  304),    p( 306,  306),    p( 298,  299),    p( 306,  295),    p( 308,  297),
    ...
    // rook
    [
        p( 460,  547),    p( 447,  557),    p( 440,  564),    p( 438,  561),    p( 449,  557),    p( 469,  553),    p( 480,  551),    p( 492,  544),
        p( 443,  553),    p( 441,  559),    p( 450,  559),    p( 464,  550),    p( 449,  553),    p( 465,  548),    p( 474,  545),    p( 492,  535),
        p( 444,  549),    p( 465,  543),    p( 458,  545),    p( 458,  541),    p( 484,  530),    p( 493,  527),    p( 510,  525),    p( 486,  529),
        p( 442,  549),    p( 449,  544),    p( 447,  547),    p( 452,  541),    p( 456,  533),    p( 468,  528),    p( 469,  532),    p( 468,  529),
        p( 434,  546),    p( 435,  544),    p( 435,  544),    p( 439,  541),    p( 447,  536),    p( 440,  536),    p( 454,  530),    p( 448,  529),
        p( 430,  543),    p( 430,  540),    p( 432,  539),    p( 434,  538),    p( 439,  532),    p( 451,  524),    p( 467,  515),    p( 455,  518),
        p( 432,  539),    p( 437,  538),    p( 442,  538),    p( 445,  535),    p( 451,  528),    p( 463,  520),    p( 472,  516),    p( 442,  526),
        p( 442,  544),    p( 438,  539),    p( 440,  542),    p( 444,  536),    p( 449,  529),    p( 456,  531),    p( 452,  531),    p( 447,  534),
    ],
    // queen
    [
        p( 877,  964),    p( 877,  978),    p( 893,  991),    p( 913,  984),    p( 911,  989),    p( 933,  976),    p( 977,  931),    p( 925,  961),
        p( 888,  951),    p( 863,  981),    p( 863, 1009),    p( 857, 1025),    p( 863, 1038),    p( 902,  999),    p( 902,  987),    p( 946,  964),
        p( 894,  956),    p( 886,  972),    p( 885,  993),    p( 884, 1005),    p( 907, 1006),    p( 945,  991),    p( 951,  963),    p( 941,  970),
        p( 880,  969),    p( 885,  977),    p( 878,  987),    p( 878,  999),    p( 881, 1012),    p( 895, 1002),    p( 905, 1003),    p( 911,  981),
        p( 890,  960),    p( 877,  979),    p( 882,  979),    p( 882,  995),    p( 887,  993),    p( 888,  993),    p( 901,  984),    p( 908,  977),
        p( 886,  949),    p( 892,  964),    p( 886,  978),    p( 882,  980),    p( 888,  988),    p( 894,  978),    p( 909,  961),    p( 907,  951),
        p( 885,  953),    p( 887,  959),    p( 893,  961),    p( 893,  974),    p( 894,  973),    p( 895,  958),    p( 907,  937),    p( 915,  913),
        p( 871,  954),    p( 883,  942),    p( 884,  954),    p( 892,  956),    p( 895,  944),    p( 883,  950),    p( 886,  943),    p( 888,  926),
    ],
    // king
    [
        p( 138,  -74),    p(  54,  -21),    p(  71,  -11),    p(   3,   16),    p(  31,    4),    p(  14,   17),    p(  74,    6),    p( 238,  -76),
        p( -49,   10),    p( -70,   32),    p( -71,   38),    p(  -5,   28),    p( -39,   38),    p( -58,   51),    p( -33,   40),    p(  27,   13),
        p( -66,   15),    p( -47,   24),    p( -85,   35),    p( -94,   45),    p( -58,   41),    p( -26,   33),    p( -65,   36),    p( -15,   16),
        p( -41,    0),    p(-101,   17),    p(-115,   30),    p(-137,   39),    p(-135,   38),    p(-113,   32),    p(-127,   24),    p( -84,   17),
        p( -48,  -11),    p(-107,    6),    p(-122,   21),    p(-145,   33),    p(-142,   32),    p(-120,   20),    p(-133,   13),    p( -93,    7),
        p( -28,  -10),    p( -76,   -1),    p(-106,   12),    p(-115,   21),    p(-113,   21),    p(-120,   15),    p( -93,    4),    p( -44,    0),
        p(  39,  -23),    p( -61,   -4),    p( -74,    2),    p( -95,   11),    p(-101,   13),    p( -89,    6),    p( -60,   -7),    p(  20,  -15),
        p(  70,  -37),    p(  40,  -31),    p(  37,  -17),    p( -26,   -1),    p(  22,  -16),    p( -22,   -3),    p(  32,  -24),    p(  82,  -44),
    ],
];
...
const KING_SEMIOPEN_FILE: PhasedScore = p(-15, 6);
#[rustfmt::skip]
const BISHOP_OPENNESS: [[PhasedScore; 8]; 4] = [
    // Open
    [p(-5, 4), p(0, 7), p(-1, 6), p(3, 3), p(2, 5), p(4, 7), p(7, 4), p(18, 2)],
    // Closed
    [p(0, 0), p(0, 0), p(20, -34), p(-15, 10), p(-0, 11), p(-0, 4), p(-1, 6), p(-1, 4)],
    // SemiOpen
...
const IMMOBILE_PASSER: PhasedScore = p(-7, -36);
const PROTECTED_PASSER: PhasedScore = p(14, 2);

#[rustfmt::skip]
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
        p( -30,   35),    p( -50,   50),    p( -54,   50),    p( -44,   39),    p( -40,   26),    p( -41,   33),    p( -41,   43),    p( -37,   42),
        p( -17,   35),    p( -51,   57),    p( -53,   51),    p( -48,   40),    p( -54,   40),    p( -50,   43),    p( -62,   61),    p( -33,   44),
        p(  -8,   62),    p( -22,   63),    p( -47,   66),    p( -42,   62),    p( -50,   59),    p( -41,   63),    p( -51,   76),    p( -42,   74),
        p(  12,   84),    p(   2,   86),    p(   6,   75),    p( -16,   80),    p( -34,   81),    p( -23,   84),    p( -37,   96),    p( -35,  100),
        p(  30,  131),    p(  33,  129),    p(  25,  115),    p(   9,   94),    p(   1,  100),    p( -10,  118),    p( -29,  120),    p( -53,  142),
        p(  35,   89),    p(  31,   88),    p(  24,   92),    p(  35,   75),    p(  21,   79),    p(  19,   83),    p( -21,   99),    p( -17,   99),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
];
const UNSUPPORTED_PAWN: PhasedScore = p(-6, -8);
const DOUBLED_PAWN: PhasedScore = p(-11, -22);
const PHALANX: [PhasedScore; 6] = [p(-2, -3), p(3, 0), p(10, 4), p(24, 21), p(59, 73), p(-113, 219)];
const PAWN_PROTECTION: [PhasedScore; NUM_CHESS_PIECES] =
    [p(16, 11), p(7, 15), p(14, 20), p(10, 8), p(-3, 16), p(-43, 12)];
