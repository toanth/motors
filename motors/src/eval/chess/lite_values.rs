...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p(  19,   51),    p(  20,   51),    p(  24,   46),    p(  26,   41),    p(  25,   46),    p(  30,   55),    p(  -0,   60),    p(   4,   60),
        p( -29,   21),    p( -22,   19),    p( -11,    9),    p( -13,   12),    p( -18,    9),    p(  26,    8),    p(  17,   29),    p(   9,   25),
        p( -42,   -1),    p( -33,   -6),    p( -35,  -13),    p( -13,   -7),    p(  -9,   -9),    p(  -8,  -19),    p(  -6,   -9),    p(  -7,  -11),
    ...
    // knight
    [
        p( -62,  -46),    p( -65,    3),    p( -66,    7),    p( -49,    9),    p(  -8,   -3),    p( -64,   -2),    p( -55,  -13),    p( -62,  -57),
        p( -19,    4),    p(  -7,   10),    p(   6,   -0),    p(   8,    3),    p(  13,   -3),    p(  22,  -11),    p(   1,    1),    p( -14,   -8),
        p(  -6,    2),    p(  11,   -3),    p(  15,    3),    p(  26,    3),    p(  37,    0),    p(  54,  -10),    p(   1,   -3),    p(   2,   -4),
        p(  14,    6),    p(  21,    3),    p(  34,    7),    p(  34,   13),    p(  33,   11),    p(  35,    9),    p(  25,    9),    p(  35,   -1),
        p(   8,    6),    p(  19,    0),    p(  21,    7),    p(  30,    9),    p(  28,   11),    p(  35,   -2),    p(  33,   -3),    p(  24,    5),
        p( -15,   -6),    p(  -7,   -7),    p(   1,   -9),    p(  10,    3),    p(  15,    1),    p(  13,  -19),    p(  13,  -13),    p(   8,   -5),
        p( -22,    0),    p(  -8,    3),    p(  -6,   -2),    p(   3,   -1),    p(  11,   -5),    p(   5,   -9),    p(   9,   -1),    p(   4,    7),
        p( -45,   -7),    p( -13,   -4),    p( -23,   -4),    p(  -2,    1),    p(   4,    1),    p(   4,   -9),    p(  -6,   -1),    p( -21,   -2),
    ],
    // bishop
    [
        p( -24,   14),    p( -37,    8),    p( -62,    4),    p( -59,   11),    p( -64,    7),    p( -58,    5),    p( -38,    8),    p( -40,    5),
        p( -11,    2),    p( -11,    3),    p(   0,    1),    p( -14,    1),    p(  -6,   -3),    p(   1,   -3),    p( -39,   11),    p( -20,    0),
        p(   1,    5),    p(  11,    1),    p(  -4,    4),    p(   8,   -5),    p(   7,    0),    p(  38,   -1),    p(  23,    2),    p(  17,   11),
        p(  -4,    5),    p(   3,    1),    p(  11,   -4),    p(  12,    4),    p(  12,    1),    p(  12,    0),    p(  17,   -2),    p(  -2,    2),
        p(  -3,    1),    p(  -7,    2),    p(  -2,    2),    p(  12,   -1),    p(   8,   -1),    p(  10,   -6),    p(  -3,   -2),    p(  23,  -10),
        p(  -3,    1),    p(   4,    0),    p(   2,    3),    p(  -0,    2),    p(   8,    1),    p(   6,   -5),    p(  14,  -11),    p(  13,   -3),
        p(   9,   -2),    p(   0,   -2),    p(  10,   -4),    p(   3,    4),    p(   5,    2),    p(  12,    0),    p(  18,   -7),    p(  12,   -3),
        p(   5,   -3),    p(  13,   -1),    p(   6,    5),    p(  -0,    4),    p(  13,    3),    p(  -6,    7),    p(   6,    1),    p(  10,   -7),
    ],
    // rook
    [
        p( -38,   44),    p( -41,   47),    p( -51,   52),    p( -53,   51),    p( -43,   47),    p( -25,   48),    p( -33,   49),    p(   0,   31),
        p( -31,   43),    p( -32,   46),    p( -25,   46),    p( -10,   37),    p( -22,   40),    p(   4,   36),    p(   6,   35),    p(  15,   24),
        p( -32,   38),    p( -14,   32),    p( -20,   34),    p( -21,   28),    p(   3,   21),    p(  20,   16),    p(  26,   21),    p(   1,   22),
        p( -34,   38),    p( -25,   33),    p( -25,   34),    p( -22,   30),    p( -16,   26),    p(  -0,   22),    p(  -5,   28),    p( -10,   24),
        p( -44,   35),    p( -41,   32),    p( -40,   33),    p( -33,   29),    p( -26,   27),    p( -28,   27),    p( -12,   23),    p( -28,   22),
        p( -48,   30),    p( -42,   25),    p( -42,   26),    p( -39,   26),    p( -29,   19),    p( -20,   14),    p(  -5,    8),    p( -20,   13),
        p( -47,   27),    p( -42,   25),    p( -34,   25),    p( -30,   21),    p( -23,   16),    p( -10,    9),    p(  -0,    5),    p( -36,   19),
        p( -40,   32),    p( -40,   26),    p( -41,   29),    p( -37,   24),    p( -30,   18),    p( -29,   22),    p( -41,   29),    p( -44,   23),
    ],
    // queen
    [
        p( -12,   60),    p( -10,   64),    p(   9,   66),    p(  30,   59),    p(  36,   62),    p(  54,   56),    p(  70,   25),    p(  23,   44),
        ...
        p(  22,   47),    p(  26,   50),    p(  25,   48),    p(  19,   63),    p(  25,   65),    p(  41,   61),    p(  44,   68),    p(  49,   55),
        p(  18,   48),    p(  17,   48),    p(  18,   47),    p(  20,   56),    p(  25,   58),    p(  28,   56),    p(  36,   57),    p(  39,   51),
        p(  18,   32),    p(  23,   36),    p(  19,   47),    p(  17,   50),    p(  21,   57),    p(  31,   44),    p(  39,   39),    p(  36,   28),
        p(  19,   29),    p(  17,   38),    p(  22,   40),    p(  22,   52),    p(  23,   53),    p(  27,   31),    p(  35,   18),    p(  24,   20),
        p(   3,   42),    p(  13,   32),    p(  13,   39),    p(  17,   45),    p(  19,   33),    p(   7,   40),    p(   1,   25),    p(  11,    6),
    ],
    // king
    [
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(  61,    9),    p(  67,    6),    p(  73,   -2),    p(  71,  -41),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(  55,   16),    p(  28,   26),    p(  33,   18),    p(  10,   11),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(  19,   26),    p(  34,   19),    p(  28,   13),    p( -13,   15),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p( -46,   23),    p( -29,   17),    p( -28,    5),    p( -47,   10),
...
const BAD_BISHOP: [PhasedScore; 9] =
    [p(16, 16), p(17, 12), p(16, 2), p(11, -5), p(6, -11), p(2, -19), p(-4, -27), p(-10, -38), p(-21, -42)];
...
const PROTECTED_PASSER: PhasedScore = p(7, -1);

#[rustfmt::skip]
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
        p( -25,   35),    p( -27,   51),    p( -38,   44),    p( -40,   27),    p( -38,   27),    p( -28,   25),    p( -15,   27),    p( -40,   30),
        p( -19,   33),    p( -33,   52),    p( -35,   42),    p( -35,   28),    p( -48,   35),    p( -43,   33),    p( -34,   40),    p( -33,   28),
        p( -12,   44),    p( -20,   43),    p( -32,   43),    p( -27,   41),    p( -37,   45),    p( -33,   46),    p( -35,   53),    p( -55,   53),
        p(   0,   53),    p(  -2,   51),    p(  -0,   42),    p( -12,   50),    p( -26,   57),    p( -18,   61),    p( -18,   64),    p( -39,   65),
        p(   7,   55),    p(  20,   48),    p(   7,   42),    p(  -5,   32),    p(  -1,   43),    p(  -8,   55),    p( -22,   56),    p( -43,   61),
        p(  19,   51),    p(  20,   51),    p(  24,   46),    p(  26,   41),    p(  25,   46),    p(  30,   55),    p(  -0,   60),    p(   4,   60),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
];
const CANDIDATE_PASSER: [PhasedScore; 6] = [p(-0, 4), p(4, 8), p(7, 17), p(11, 28), p(18, 55), p(21, 54)];
...
const PAWN_ATTACKS: [PhasedScore; NUM_CHESS_PIECES] = [p(0, 0), p(48, 20), p(50, 42), p(58, 9), p(49, -6), p(0, 0)];
...
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    ...
    [p(3, 8), p(11, 20), p(-51, -31), p(8, 12), p(10, 18), p(5, 6)],
    [p(-3, 8), p(8, 12), p(4, 16), p(7, 13), p(4, 33), p(15, -1)],
    [p(-0, 10), p(6, 12), p(5, 8), p(3, 18), p(-71, -68), p(2, -2)],
    [p(24, 5), p(13, 16), p(18, 10), p(4, 10), p(16, -4), p(0, 0)],
];
const KING_ZONE_ATTACK: [PhasedScore; 6] = [p(7, -20), p(18, -8), p(9, -2), p(15, -16), p(-5, 9), p(7, -0)];
...
const DISCOVERED_CHECK: [PhasedScore; NUM_CHESS_PIECES] =
    [p(10, -5), p(63, 26), p(66, 10), p(66, 67), p(0, 0), p(25, -23)];
