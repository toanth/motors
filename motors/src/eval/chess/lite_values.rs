...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( 881,  966),    p( 887,  974),    p( 880,  984),    p( 882,  995),    p( 884, 1008),    p( 897,  998),    p( 906,  999),    p( 914,  975),
        p( 891,  957),    p( 878,  977),    p( 885,  977),    p( 884,  994),    p( 889,  990),    p( 890,  991),    p( 903,  980),    p( 909,  973),
