...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( 129,  162),    p( 126,  161),    p( 118,  165),    p( 126,  149),    p( 113,  154),    p( 111,  157),    p(  71,  174),    p(  74,  173),
        p(  76,  119),    p(  72,  121),    p(  78,  113),    p(  85,  109),    p(  73,  104),    p( 127,  104),    p(  98,  123),    p( 100,  116),
        p(  58,  107),    p(  64,  100),    p(  61,   94),    p(  83,   96),    p(  89,   95),    p(  83,   84),    p(  78,   94),    p(  75,   91),
        p(  52,   94),    p(  53,   95),    p(  75,   91),    p(  94,   93),    p(  87,   95),    p(  83,   91),    p(  69,   86),    p(  63,   81),
        p(  45,   92),    p(  50,   88),    p(  71,   91),    p(  80,   94),    p(  82,   92),    p(  77,   91),    p(  69,   78),    p(  54,   81),
        p(  54,   96),    p(  59,   94),    p(  62,   93),    p(  57,   99),    p(  61,  101),    p(  77,   93),    p(  82,   83),    p(  60,   85),
        p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),
    ],
    // knight
    [
        p( 178,  280),    p( 195,  316),    p( 215,  326),    p( 246,  314),    p( 276,  316),    p( 198,  309),    p( 222,  308),    p( 204,  264),
        p( 272,  316),    p( 288,  320),    p( 296,  311),    p( 297,  315),    p( 297,  310),    p( 311,  301),    p( 276,  319),    p( 285,  304),
        p( 291,  312),    p( 305,  308),    p( 306,  313),    p( 316,  315),    p( 330,  311),    p( 346,  300),    p( 293,  309),    p( 287,  310),
        p( 307,  318),    p( 315,  315),    p( 329,  315),    p( 329,  323),    p( 324,  323),    p( 325,  322),    p( 318,  320),    p( 329,  313),
        p( 303,  320),    p( 310,  310),    p( 316,  316),    p( 325,  318),    p( 322,  322),    p( 329,  308),    p( 328,  308),    p( 317,  316),
        p( 280,  305),    p( 287,  305),    p( 299,  299),    p( 304,  312),    p( 309,  311),    p( 298,  293),    p( 306,  296),    p( 297,  310),
        p( 274,  313),    p( 285,  317),    p( 288,  307),    p( 296,  312),    p( 300,  307),    p( 294,  306),    p( 299,  311),    p( 293,  321),
        p( 246,  311),    p( 282,  307),    p( 272,  311),    p( 292,  314),    p( 300,  312),    p( 295,  302),    p( 288,  311),    p( 272,  310),
    ],
    // bishop
    [
        p( 277,  314),    p( 252,  317),    p( 242,  309),    p( 223,  319),    p( 212,  318),    p( 231,  308),    p( 271,  307),    p( 257,  311),
        p( 289,  305),    p( 283,  306),    p( 293,  308),    p( 278,  307),    p( 288,  304),    p( 292,  303),    p( 272,  311),    p( 275,  307),
        p( 297,  312),    p( 306,  308),    p( 288,  307),    p( 305,  301),    p( 301,  304),    p( 337,  307),    p( 316,  306),    p( 319,  314),
        p( 291,  312),    p( 298,  306),    p( 309,  302),    p( 309,  308),    p( 312,  304),    p( 310,  304),    p( 312,  305),    p( 289,  310),
        p( 289,  307),    p( 289,  308),    p( 298,  305),    p( 313,  304),    p( 306,  300),    p( 306,  300),    p( 291,  304),    p( 314,  299),
        p( 298,  309),    p( 300,  306),    p( 302,  306),    p( 300,  304),    p( 306,  307),    p( 299,  299),    p( 307,  295),    p( 309,  299),
    ...
    // rook
    [
        p( 454,  554),    p( 440,  565),    p( 432,  572),    p( 431,  568),    p( 443,  564),    p( 468,  559),    p( 470,  560),    p( 484,  553),
        p( 454,  559),    p( 452,  564),    p( 459,  565),    p( 475,  555),    p( 460,  558),    p( 481,  553),    p( 484,  552),    p( 502,  541),
        p( 452,  555),    p( 469,  549),    p( 465,  550),    p( 464,  545),    p( 491,  537),    p( 504,  533),    p( 518,  534),    p( 493,  536),
        p( 451,  555),    p( 460,  550),    p( 460,  552),    p( 462,  548),    p( 469,  541),    p( 484,  536),    p( 482,  543),    p( 477,  538),
        p( 442,  552),    p( 445,  551),    p( 446,  550),    p( 453,  547),    p( 457,  544),    p( 454,  544),    p( 466,  539),    p( 457,  537),
        p( 438,  549),    p( 440,  546),    p( 443,  545),    p( 444,  544),    p( 451,  539),    p( 461,  532),    p( 477,  522),    p( 460,  525),
        p( 438,  546),    p( 443,  544),    p( 449,  544),    p( 453,  541),    p( 459,  535),    p( 474,  526),    p( 480,  522),    p( 448,  531),
        p( 444,  549),    p( 443,  545),    p( 444,  548),    p( 449,  541),    p( 454,  534),    p( 459,  535),    p( 456,  535),    p( 448,  537),
    ],
    // queen
    [
        p( 870,  966),    p( 871,  979),    p( 884,  992),    p( 905,  983),    p( 909,  986),    p( 929,  979),    p( 966,  935),    p( 911,  970),
        p( 900,  957),    p( 878,  983),    p( 879, 1005),    p( 874, 1019),    p( 879, 1033),    p( 914, 1002),    p( 927,  978),    p( 956,  969),
        p( 899,  967),    p( 895,  976),    p( 892,  997),    p( 895, 1004),    p( 899, 1016),    p( 956,  991),    p( 957,  970),    p( 947,  976),
        p( 892,  973),    p( 897,  978),    p( 895,  986),    p( 889, 1001),    p( 895, 1010),    p( 915,  996),    p( 921, 1000),    p( 926,  981),
        p( 895,  964),    p( 890,  979),    p( 891,  979),    p( 893,  994),    p( 898,  990),    p( 902,  990),    p( 911,  983),    p( 918,  976),
        p( 893,  950),    p( 899,  963),    p( 895,  976),    p( 891,  978),    p( 897,  987),    p( 903,  976),    p( 916,  963),    p( 913,  952),
        p( 891,  952),    p( 893,  957),    p( 899,  960),    p( 898,  975),    p( 900,  974),    p( 902,  958),    p( 913,  939),    p( 922,  914),
        p( 878,  956),    p( 891,  943),    p( 891,  956),    p( 896,  957),    p( 901,  948),    p( 888,  952),    p( 889,  943),    p( 896,  928),
    ],
    // king
    [
        p( 179,  -65),    p(  95,  -15),    p( 116,   -6),    p(  52,   13),    p(  65,    4),    p(  28,   17),    p(  83,    5),    p( 220,  -67),
        p(  -3,   16),    p( -37,   31),    p( -42,   38),    p(  18,   23),    p( -14,   33),    p( -36,   45),    p( -23,   35),    p(   9,   19),
        p( -35,   23),    p( -24,   23),    p( -59,   37),    p( -68,   41),    p( -31,   38),    p(   1,   30),    p( -51,   33),    p( -13,   22),
        p( -17,    8),    p( -79,   17),    p( -95,   31),    p(-122,   37),    p(-116,   37),    p( -97,   30),    p(-104,   21),    p( -95,   24),
        p( -38,    0),    p( -95,    6),    p(-111,   22),    p(-137,   32),    p(-135,   31),    p(-111,   18),    p(-126,   11),    p(-111,   15),
        p( -34,    4),    p( -80,    0),    p(-106,   13),    p(-114,   19),    p(-111,   19),    p(-121,   13),    p( -98,    2),    p( -68,   10),
        p(  24,   -5),    p( -71,   -5),    p( -80,    1),    p( -98,    7),    p(-105,   11),    p( -90,    2),    p( -66,  -12),    p(   1,   -3),
        p(  50,  -15),    p(  41,  -29),    p(  37,  -17),    p( -20,   -2),    p(  25,  -15),    p( -16,   -3),    p(  32,  -24),    p(  61,  -29),
    ],
];
...
const BISHOP_OPENNESS: [[PhasedScore; 8]; 4] = [
    // Open
    [p(-3, 6), p(2, 8), p(-1, 7), p(4, 5), p(5, 6), p(5, 8), p(8, 5), p(19, 2)],
    // Closed
    [p(0, 0), p(0, 0), p(17, -12), p(-13, 11), p(1, 12), p(1, 6), p(0, 8), p(1, 5)],
    // SemiOpen
    [p(0, 0), p(-5, 27), p(7, 20), p(3, 12), p(2, 12), p(5, 7), p(3, 3), p(11, 6)],
    // SemiClosed
    [p(0, 0), p(12, -11), p(7, 7), p(5, 0), p(8, 2), p(2, 5), p(5, 5), p(3, 5)],
];
...
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        ...
        p(   1,   70),    p(   7,   68),    p(   0,   53),    p( -19,   40),    p( -17,   51),    p( -41,   58),    p( -49,   60),    p( -84,   80),
        p(  29,   62),    p(  26,   61),    p(  18,   65),    p(  26,   49),    p(  13,   54),    p(  11,   57),    p( -29,   74),    p( -26,   73),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
];
const CANDIDATE_PASSER: [PhasedScore; 6] = [p(1, 5), p(5, 8), p(8, 17), p(15, 22), p(17, 70), p(15, 62)];
const UNSUPPORTED_PAWN: PhasedScore = p(-7, -7);
const DOUBLED_PAWN: PhasedScore = p(-6, -22);
const PHALANX: [PhasedScore; 6] = [p(-0, -0), p(5, 3), p(8, 6), p(21, 20), p(56, 76), p(-92, 222)];
const PAWN_PROTECTION: [PhasedScore; NUM_CHESS_PIECES] =
    [p(17, 14), p(7, 18), p(15, 21), p(7, 10), p(-3, 14), p(-44, 11)];
const PAWN_ATTACKS: [PhasedScore; NUM_CHESS_PIECES] = [p(0, 0), p(49, 21), p(52, 45), p(68, 4), p(54, -11), p(0, 0)];
...
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(2, 8), p(8, 7), p(6, 11), p(13, 7), p(7, 16), p(11, 6)],
    [p(2, 9), p(12, 21), p(-5, -44), p(8, 12), p(10, 20), p(3, 6)],
    [p(2, 4), p(12, 8), p(8, 13), p(11, 10), p(9, 28), p(20, -4)],
    [p(2, 3), p(8, 4), p(6, -2), p(4, 14), p(-50, -234), p(5, -10)],
    [p(62, -2), p(40, 10), p(44, 5), p(22, 7), p(34, -4), p(0, 0)],
];
const THREATS: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(-4, 14), p(0, 0), p(19, 16), p(55, 9), p(42, -2), p(0, 0)],
    [p(-2, 12), p(21, 26), p(0, 0), p(37, 24), p(47, 90), p(0, 0)],
    [p(-3, 18), p(11, 18), p(19, 14), p(0, 0), p(66, 41), p(0, 0)],
    [p(-2, 9), p(2, 9), p(1, 25), p(0, 12), p(0, 0), p(0, 0)],
    [p(60, 20), p(-21, 23), p(15, 15), p(-13, 23), p(0, 0), p(0, 0)],
];
const THREATS_STM: PhasedScore = p(25, 40);
const KING_ZONE_ATTACK: [PhasedScore; 6] = [p(-20, -13), p(20, -10), p(9, -3), p(15, -15), p(-0, 5), p(-2, 3)];
const CAN_GIVE_CHECK: [PhasedScore; 5] = [p(0, 0), p(12, -0), p(-4, 8), p(16, -8), p(-13, 24)];
const CHECK_STM: PhasedScore = p(35, 22);
const DISCOVERED_CHECK_STM: PhasedScore = p(142, 38);
const DISCOVERED_CHECK: [PhasedScore; NUM_CHESS_PIECES] =
    [p(-7, -18), p(69, -2), p(106, -32), p(66, 81), p(0, 0), p(-22, -22)];
const PIN: [PhasedScore; NUM_CHESS_PIECES - 1] = [p(6, -17), p(27, 30), p(17, 35), p(43, 9), p(64, 3)];
