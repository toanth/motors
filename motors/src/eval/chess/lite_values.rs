...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( 131,  186),    p( 128,  185),    p( 120,  188),    p( 129,  171),    p( 117,  175),    p( 116,  179),    p(  75,  196),    p(  80,  196),
        p(  70,  121),    p(  71,  123),    p(  79,  117),    p(  87,  118),    p(  77,  117),    p( 126,  107),    p( 102,  128),    p(  96,  119),
        p(  53,  111),    p(  64,  105),    p(  63,  101),    p(  84,  100),    p(  93,   99),    p(  85,   90),    p(  77,  100),    p(  73,   95),
        p(  49,   98),    p(  54,  100),    p(  78,   93),    p(  93,   97),    p(  91,   98),    p(  87,   94),    p(  70,   91),    p(  60,   85),
        p(  42,   96),    p(  50,   92),    p(  72,   96),    p(  82,   98),    p(  83,   96),    p(  77,   94),    p(  69,   83),    p(  52,   84),
        p(  54,   99),    p(  58,   98),    p(  62,   98),    p(  59,  105),    p(  61,  107),    p(  76,   98),    p(  81,   87),    p(  59,   89),
        p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),
    ],
    // knight
    [
        p( 174,  280),    p( 195,  312),    p( 213,  324),    p( 252,  313),    p( 281,  314),    p( 199,  309),    p( 215,  309),    p( 201,  263),
        p( 267,  313),    p( 284,  317),    p( 300,  309),    p( 305,  313),    p( 303,  309),    p( 315,  298),    p( 275,  315),    p( 271,  305),
        p( 287,  309),    p( 307,  304),    p( 309,  310),    p( 323,  314),    p( 339,  308),    p( 353,  297),    p( 294,  304),    p( 286,  308),
        p( 302,  316),    p( 310,  310),    p( 326,  314),    p( 328,  321),    p( 326,  318),    p( 322,  317),    p( 311,  312),    p( 320,  311),
        p( 299,  319),    p( 305,  308),    p( 314,  314),    p( 321,  317),    p( 320,  319),    p( 325,  304),    p( 323,  304),    p( 312,  314),
        ...
        p( 239,  312),    p( 281,  305),    p( 267,  307),    p( 287,  312),    p( 296,  309),    p( 292,  299),    p( 288,  308),    p( 263,  313),
    ],
    // bishop
    [
        p( 276,  310),    p( 252,  314),    p( 239,  307),    p( 223,  317),    p( 217,  314),    p( 225,  308),    p( 273,  303),    p( 250,  309),
        p( 283,  302),    p( 279,  304),    p( 290,  306),    p( 277,  304),    p( 289,  301),    p( 292,  300),    p( 267,  308),    p( 271,  302),
        ...
        p( 289,  308),    p( 284,  309),    p( 295,  304),    p( 308,  305),    p( 302,  301),    p( 299,  302),    p( 285,  306),    p( 309,  302),
        p( 296,  310),    p( 299,  305),    p( 299,  307),    p( 299,  305),    p( 305,  307),    p( 298,  300),    p( 305,  296),    p( 307,  300),
        p( 308,  309),    p( 303,  301),    p( 308,  302),    p( 299,  309),    p( 301,  306),    p( 302,  305),    p( 311,  296),    p( 308,  296),
        p( 298,  305),    p( 308,  307),    p( 308,  307),    p( 290,  310),    p( 306,  308),    p( 294,  310),    p( 302,  298),    p( 301,  293),
    ],
    // rook
    [
        p( 459,  548),    p( 447,  558),    p( 441,  565),    p( 439,  562),    p( 451,  557),    p( 470,  553),    p( 480,  551),    p( 491,  544),
        p( 443,  554),    p( 441,  560),    p( 450,  560),    p( 465,  551),    p( 451,  554),    p( 467,  549),    p( 475,  546),    p( 491,  535),
        p( 445,  550),    p( 464,  544),    p( 458,  546),    p( 458,  542),    p( 484,  531),    p( 494,  528),    p( 512,  527),    p( 486,  529),
        p( 442,  550),    p( 448,  546),    p( 447,  548),    p( 453,  542),    p( 457,  534),    p( 468,  529),    p( 468,  533),    p( 468,  529),
        p( 435,  548),    p( 434,  546),    p( 435,  546),    p( 440,  542),    p( 447,  538),    p( 441,  537),    p( 454,  531),    p( 448,  530),
        p( 430,  545),    p( 430,  541),    p( 432,  540),    p( 435,  540),    p( 440,  535),    p( 451,  526),    p( 467,  515),    p( 454,  519),
        p( 432,  540),    p( 436,  539),    p( 442,  539),    p( 444,  536),    p( 452,  530),    p( 464,  520),    p( 472,  515),    p( 443,  526),
        p( 442,  544),    p( 438,  539),    p( 439,  543),    p( 444,  537),    p( 450,  530),    p( 456,  530),    p( 452,  529),    p( 448,  533),
    ],
    // queen
    [
        p( 878,  962),    p( 880,  976),    p( 895,  989),    p( 915,  983),    p( 913,  987),    p( 933,  976),    p( 979,  928),    p( 925,  959),
        p( 889,  949),    p( 864,  981),    p( 865, 1009),    p( 858, 1026),    p( 864, 1037),    p( 905,  998),    p( 906,  983),    p( 948,  961),
        p( 894,  956),    p( 887,  972),    p( 886,  994),    p( 885, 1005),    p( 908, 1007),    p( 946,  991),    p( 953,  963),    p( 941,  969),
        p( 881,  968),    p( 886,  977),    p( 879,  988),    p( 880, 1000),    p( 881, 1014),    p( 896, 1003),    p( 905, 1004),    p( 912,  980),
        p( 890,  960),    p( 877,  981),    p( 883,  981),    p( 883,  998),    p( 887,  994),    p( 889,  995),    p( 901,  983),    p( 908,  976),
        p( 886,  950),    p( 892,  966),    p( 886,  981),    p( 883,  983),    p( 888,  991),    p( 895,  979),    p( 909,  962),    p( 908,  950),
        p( 886,  953),    p( 887,  960),    p( 893,  962),    p( 892,  976),    p( 894,  974),    p( 895,  958),    p( 907,  937),    p( 914,  912),
        p( 872,  954),    p( 884,  941),    p( 885,  953),    p( 893,  955),    p( 896,  944),    p( 883,  948),    p( 884,  941),    p( 889,  925),
    ],
    // king
    [
        p( 158,  -72),    p(  58,  -22),    p(  80,  -13),    p(  14,   15),    p(  41,    2),    p(  18,   15),    p(  79,    4),    p( 211,  -73),
        p( -29,   15),    p( -65,   33),    p( -68,   40),    p(  -1,   30),    p( -38,   39),    p( -59,   52),    p( -33,   40),    p(   7,   16),
        p( -49,   19),    p( -44,   23),    p( -82,   35),    p( -92,   46),    p( -58,   41),    p( -24,   32),    p( -63,   34),    p( -30,   19),
        p( -30,    6),    p( -99,   16),    p(-115,   30),    p(-136,   39),    p(-134,   38),    p(-111,   30),    p(-124,   22),    p(-100,   20),
        p( -42,   -3),    p(-108,    6),    p(-123,   21),    p(-148,   35),    p(-146,   32),    p(-121,   20),    p(-134,   13),    p(-117,   14),
        p( -32,    1),    p( -82,    1),    p(-111,   13),    p(-119,   23),    p(-116,   23),    p(-125,   15),    p(-101,    5),    p( -72,   11),
        p(  27,   -7),    p( -70,   -3),    p( -81,    3),    p(-100,   13),    p(-106,   15),    p( -92,    7),    p( -66,   -7),    p(   2,   -2),
        p(  50,  -22),    p(  42,  -33),    p(  39,  -22),    p( -20,   -5),    p(  30,  -20),    p( -17,   -6),    p(  34,  -27),    p(  61,  -33),
    ],
];

const BISHOP_PAIR: PhasedScore = p(23, 52);
const BAD_BISHOP: [PhasedScore; 9] =
    [p(9, 21), p(10, 18), p(10, 7), p(6, -0), p(2, -8), p(-1, -17), p(-7, -26), p(-14, -39), p(-25, -50)];
...
const BISHOP_OPENNESS: [[PhasedScore; 8]; 4] = [
    // Open
    [p(-5, 4), p(0, 6), p(-1, 5), p(2, 3), p(2, 5), p(4, 7), p(7, 5), p(19, 2)],
    // Closed
    [p(0, 0), p(0, 0), p(21, -31), p(-14, 11), p(-1, 11), p(0, 5), p(-2, 7), p(-1, 5)],
    // SemiOpen
    [p(0, 0), p(-15, 24), p(2, 16), p(-0, 10), p(-0, 9), p(4, 6), p(0, 2), p(10, 5)],
    // SemiClosed
    [p(0, 0), p(12, -13), p(7, 6), p(3, 0), p(6, 1), p(1, 4), p(3, 5), p(2, 4)],
];
const NO_PAWNS: PhasedScore = p(94, -28);
...
const CLOSE_KING_PASSER: PhasedScore = p(-6, 30);

#[rustfmt::skip]
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
        p( -22,   35),    p( -36,   51),    p( -43,   49),    p( -38,   37),    p( -27,   26),    p( -28,   33),    p( -22,   42),    p( -27,   41),
        p( -12,   35),    p( -42,   58),    p( -44,   50),    p( -41,   39),    p( -44,   39),    p( -37,   42),    p( -46,   61),    p( -22,   43),
        p(  -4,   62),    p( -15,   63),    p( -39,   64),    p( -34,   58),    p( -43,   57),    p( -31,   61),    p( -41,   75),    p( -37,   74),
        p(  14,   83),    p(   8,   85),    p(  11,   71),    p( -11,   76),    p( -30,   76),    p( -17,   80),    p( -28,   93),    p( -31,   97),
        p(  29,  128),    p(  34,  126),    p(  26,  109),    p(   8,   87),    p(   9,   95),    p(  -7,  112),    p( -26,  114),    p( -54,  137),
        p(  31,   86),    p(  28,   85),    p(  20,   88),    p(  29,   71),    p(  17,   75),    p(  16,   79),    p( -25,   96),    p( -20,   96),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
];
const UNSUPPORTED_PAWN: PhasedScore = p(-7, -9);
const DOUBLED_PAWN: PhasedScore = p(-7, -23);
const PHALANX: [PhasedScore; 6] = [p(-0, -2), p(5, 1), p(9, 5), p(24, 24), p(66, 81), p(-91, 223)];
const PAWN_PROTECTION: [PhasedScore; NUM_CHESS_PIECES] =
    [p(17, 12), p(7, 14), p(14, 18), p(9, 7), p(-3, 15), p(-45, 7)];
...
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    ...
    [p(2, -1), p(9, 1), p(7, -4), p(4, 15), p(-55, -269), p(5, -11)],
    [p(61, -3), p(39, 6), p(44, -0), p(22, 4), p(34, -12), p(0, 0)],
];
const KING_ZONE_ATTACK: [PhasedScore; 6] = [p(-20, -14), p(19, -9), p(10, -3), p(15, -11), p(-1, 12), p(-7, 7)];
...
pub trait LiteValues: Debug + Default + Copy + Clone + Send + 'static + StaticallyNamedEntity {
    ...
    fn no_pawns() -> SingleFeatureScore<Self::Score>;
