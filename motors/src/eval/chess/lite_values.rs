...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p(  41,   90),    p(  47,   85),    p(  69,   90),    p(  79,   93),    p(  80,   91),    p(  75,   89),    p(  66,   76),    p(  50,   78),
        p(  52,   93),    p(  56,   92),    p(  58,   92),    p(  53,   98),    p(  57,   99),    p(  73,   91),    p(  79,   81),    p(  57,   83),
        p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),
    ],
    // knight
    [
        p( 173,  281),    p( 193,  314),    p( 211,  326),    p( 251,  314),    p( 279,  316),    p( 199,  310),    p( 216,  309),    p( 201,  265),
        p( 266,  314),    p( 283,  319),    p( 298,  311),    p( 302,  314),    p( 301,  310),    p( 310,  299),    p( 271,  317),    p( 273,  306),
        p( 285,  311),    p( 305,  305),    p( 307,  311),    p( 321,  315),    p( 336,  310),    p( 350,  297),    p( 290,  306),    p( 287,  309),
        p( 301,  316),    p( 309,  310),    p( 325,  313),    p( 326,  321),    p( 325,  318),    p( 320,  317),    p( 311,  313),    p( 319,  311),
        p( 299,  318),    p( 303,  307),    p( 313,  312),    p( 321,  315),    p( 319,  319),    p( 324,  304),    p( 322,  304),    p( 312,  314),
        p( 275,  304),    p( 283,  303),    p( 297,  297),    p( 301,  310),    p( 306,  308),    p( 296,  291),    p( 302,  294),    p( 293,  308),
        p( 270,  311),    p( 281,  315),    p( 285,  305),    p( 294,  309),    p( 299,  305),    p( 290,  304),    p( 294,  309),    p( 289,  322),
        p( 241,  309),    p( 281,  306),    p( 267,  309),    p( 288,  313),    p( 296,  311),    p( 291,  302),    p( 288,  310),    p( 264,  310),
    ],
    // bishop
    [
        p( 275,  312),    p( 249,  316),    p( 236,  309),    p( 222,  318),    p( 214,  316),    p( 227,  308),    p( 272,  305),    p( 251,  310),
        p( 283,  304),    p( 278,  305),    p( 290,  307),    p( 276,  306),    p( 288,  302),    p( 292,  301),    p( 264,  310),    p( 273,  303),
        ...
        p( 288,  306),    p( 284,  308),    p( 294,  305),    p( 308,  304),    p( 302,  300),    p( 299,  302),    p( 285,  305),    p( 310,  299),
        p( 296,  308),    p( 298,  305),    p( 299,  306),    p( 299,  304),    p( 305,  306),    p( 298,  299),    p( 305,  296),    p( 307,  298),
        p( 307,  308),    p( 304,  301),    p( 308,  301),    p( 299,  309),    p( 301,  307),    p( 303,  306),    p( 311,  296),    p( 308,  295),
        p( 299,  305),    p( 309,  307),    p( 307,  308),    p( 291,  311),    p( 306,  310),    p( 294,  312),    p( 302,  301),    p( 301,  293),
    ],
    // rook
    [
        p( 451,  548),    p( 436,  560),    p( 427,  567),    p( 427,  564),    p( 440,  559),    p( 467,  553),    p( 475,  553),    p( 485,  546),
        p( 444,  554),    p( 441,  560),    p( 450,  561),    p( 464,  552),    p( 450,  554),    p( 464,  549),    p( 473,  546),    p( 491,  535),
        p( 443,  550),    p( 463,  545),    p( 457,  546),    p( 457,  542),    p( 481,  531),    p( 492,  528),    p( 508,  528),    p( 484,  530),
        p( 440,  550),    p( 446,  546),    p( 446,  548),    p( 451,  543),    p( 455,  534),    p( 466,  530),    p( 466,  534),    p( 466,  530),
        p( 434,  547),    p( 433,  545),    p( 434,  545),    p( 440,  542),    p( 446,  538),    p( 441,  537),    p( 453,  533),    p( 448,  530),
        p( 430,  544),    p( 431,  541),    p( 432,  540),    p( 435,  539),    p( 441,  534),    p( 452,  526),    p( 468,  517),    p( 454,  520),
        p( 433,  540),    p( 437,  539),    p( 443,  539),    p( 446,  536),    p( 452,  530),    p( 467,  521),    p( 474,  517),    p( 443,  526),
        p( 442,  545),    p( 439,  540),    p( 440,  543),    p( 445,  537),    p( 450,  530),    p( 456,  531),    p( 452,  532),    p( 448,  534),
    ],
    // queen
    [
        p( 866,  966),    p( 868,  979),    p( 880,  994),    p( 904,  986),    p( 903,  990),    p( 928,  977),    p( 968,  934),    p( 915,  964),
        p( 890,  952),    p( 866,  978),    p( 867, 1006),    p( 860, 1023),    p( 867, 1034),    p( 905,  998),    p( 908,  981),    p( 947,  964),
        p( 894,  959),    p( 889,  971),    p( 887,  992),    p( 888, 1001),    p( 899, 1009),    p( 947,  988),    p( 951,  965),    p( 942,  971),
        p( 882,  970),    p( 884,  979),    p( 881,  984),    p( 878,  999),    p( 881, 1009),    p( 898,  999),    p( 904, 1006),    p( 912,  983),
        p( 889,  963),    p( 879,  978),    p( 883,  978),    p( 885,  991),    p( 890,  990),    p( 891,  990),    p( 901,  986),    p( 909,  976),
        p( 888,  948),    p( 893,  964),    p( 888,  976),    p( 886,  978),    p( 891,  987),    p( 898,  975),    p( 910,  963),    p( 909,  951),
        p( 886,  953),    p( 888,  958),    p( 895,  960),    p( 895,  974),    p( 896,  973),    p( 898,  956),    p( 909,  937),    p( 916,  912),
        p( 874,  953),    p( 885,  941),    p( 886,  953),    p( 895,  955),    p( 897,  944),    p( 884,  949),    p( 884,  944),    p( 891,  924),
    ],
    // king
    [
        p( 151,  -69),    p(  66,  -24),    p(  80,  -13),    p(  18,   13),    p(  41,    3),    p(  25,   15),    p(  85,    4),    p( 207,  -71),
        p( -34,   16),    p( -58,   30),    p( -62,   37),    p(  -1,   27),    p( -32,   36),    p( -50,   50),    p( -28,   38),    p(   6,   18),
        p( -52,   22),    p( -40,   22),    p( -78,   34),    p( -88,   43),    p( -51,   39),    p( -17,   31),    p( -59,   34),    p( -28,   21),
        p( -27,    6),    p( -96,   15),    p(-112,   28),    p(-133,   37),    p(-132,   37),    p(-108,   30),    p(-120,   22),    p(-102,   22),
        p( -41,   -3),    p(-105,    4),    p(-122,   20),    p(-147,   33),    p(-144,   31),    p(-120,   19),    p(-135,   12),    p(-118,   14),
        p( -36,    0),    p( -82,   -1),    p(-110,   11),    p(-119,   21),    p(-116,   21),    p(-126,   14),    p(-102,    4),    p( -73,   10),
        p(  24,   -8),    p( -69,   -6),    p( -80,    1),    p( -99,   10),    p(-105,   13),    p( -91,    5),    p( -65,   -9),    p(   1,   -3),
...
const BISHOP_OPENNESS: [[PhasedScore; 8]; 4] = [
    // Open
    [p(-5, 5), p(1, 7), p(-2, 6), p(2, 4), p(2, 6), p(4, 7), p(6, 4), p(18, 2)],
    // Closed
    [p(0, 0), p(0, 0), p(19, -15), p(-14, 10), p(-1, 11), p(-0, 4), p(-2, 7), p(-1, 4)],
    // SemiOpen
    [p(0, 0), p(-12, 23), p(3, 16), p(0, 10), p(-1, 10), p(4, 6), p(1, 3), p(10, 5)],
    // SemiClosed
    [p(0, 0), p(12, -13), p(7, 6), p(3, -0), p(6, 1), p(0, 4), p(3, 4), p(2, 4)],
];
...
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        ...
        p( -41,   41),    p( -47,   54),    p( -67,   57),    p( -69,   50),    p( -58,   37),    p( -48,   38),    p( -31,   44),    p( -47,   46),
        p( -31,   36),    p( -53,   58),    p( -62,   54),    p( -62,   47),    p( -70,   46),    p( -57,   46),    p( -58,   61),    p( -42,   44),
        ...
        p(  -5,   72),    p(   5,   71),    p(  -1,   55),    p( -20,   40),    p( -15,   51),    p( -37,   58),    p( -46,   60),    p( -85,   82),
...
const PHALANX: [PhasedScore; 6] = [p(0, -0), p(6, 2), p(9, 5), p(23, 19), p(62, 75), p(-100, 222)];
const PAWN_PROTECTION: [PhasedScore; NUM_CHESS_PIECES] =
    [p(17, 12), p(7, 15), p(15, 19), p(9, 8), p(-3, 17), p(-45, 11)];
...
const THREATS: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    ...
    [p(-3, 14), p(10, 13), p(18, 8), p(0, 0), p(41, 3), p(0, 0)],
    [p(-2, 5), p(2, 4), p(-0, 17), p(0, -0), p(0, 0), p(0, 0)],
    [p(59, 20), p(-29, 18), p(4, 15), p(-19, 9), p(0, 0), p(0, 0)],
];
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(1, 8), p(8, 7), p(6, 10), p(12, 7), p(6, 18), p(10, 6)],
    [p(2, 8), p(11, 20), p(-121, -20), p(8, 13), p(10, 20), p(3, 6)],
    [p(2, 3), p(12, 7), p(8, 12), p(11, 10), p(9, 27), p(20, -3)],
    [p(1, 1), p(8, 1), p(6, -4), p(4, 13), p(-72, -245), p(4, -9)],
    [p(60, -2), p(39, 9), p(44, 3), p(22, 6), p(33, -4), p(0, 0)],
];
const KING_ZONE_ATTACK: [PhasedScore; 6] = [p(-18, -15), p(19, -9), p(9, -3), p(14, -11), p(-2, 13), p(-0, 4)];
const CAN_GIVE_CHECK: [PhasedScore; 5] = [p(0, 0), p(28, 11), p(13, 20), p(33, 1), p(5, 32)];
const PIN: [PhasedScore; NUM_CHESS_PIECES - 1] = [p(5, -17), p(23, 30), p(15, 35), p(41, 23), p(68, 33)];
const DISCOVERED_CHECK: [PhasedScore; NUM_CHESS_PIECES] =
    [p(-7, -17), p(105, 35), p(148, -8), p(57, 144), p(0, 0), p(33, 14)];
