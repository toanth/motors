...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    // knight
    [
        p( 173,  281),    p( 192,  314),    p( 213,  326),    p( 251,  314),    p( 280,  316),    p( 201,  310),    p( 217,  309),    p( 201,  265),
        p( 266,  314),    p( 283,  319),    p( 298,  311),    p( 301,  315),    p( 301,  310),    p( 308,  300),    p( 273,  317),    p( 274,  306),
        p( 285,  311),    p( 305,  305),    p( 307,  311),    p( 321,  315),    p( 336,  309),    p( 349,  297),    p( 291,  306),    p( 288,  309),
        p( 301,  316),    p( 309,  310),    p( 325,  313),    p( 325,  321),    p( 325,  317),    p( 320,  317),    p( 311,  313),    p( 319,  312),
    ...
    // bishop
    [
        p( 275,  312),    p( 249,  316),    p( 236,  309),    p( 221,  318),    p( 215,  316),    p( 227,  308),    p( 272,  306),    p( 252,  310),
    ...
    // rook
    [
        p( 451,  548),    p( 436,  560),    p( 427,  567),    p( 427,  564),    p( 440,  559),    p( 468,  553),    p( 474,  553),    p( 485,  545),
        p( 444,  554),    p( 441,  560),    p( 450,  561),    p( 464,  552),    p( 451,  554),    p( 465,  549),    p( 473,  546),    p( 491,  535),
        p( 444,  550),    p( 463,  545),    p( 457,  546),    p( 457,  542),    p( 482,  531),    p( 492,  528),    p( 508,  528),    p( 485,  530),
        p( 440,  550),    p( 446,  546),    p( 446,  548),    p( 451,  543),    p( 455,  534),    p( 466,  530),    p( 466,  534),    p( 466,  530),
        p( 434,  546),    p( 433,  545),    p( 434,  545),    p( 440,  542),    p( 446,  538),    p( 441,  537),    p( 454,  533),    p( 448,  530),
        p( 430,  544),    p( 431,  541),    p( 432,  540),    p( 435,  539),    p( 441,  534),    p( 453,  526),    p( 468,  517),    p( 454,  520),
    ...
    // queen
    [
        p( 866,  966),    p( 868,  979),    p( 881,  993),    p( 904,  986),    p( 903,  990),    p( 929,  977),    p( 968,  934),    p( 915,  964),
        p( 890,  952),    p( 867,  978),    p( 867, 1006),    p( 860, 1022),    p( 867, 1034),    p( 905,  998),    p( 908,  981),    p( 947,  964),
        ...
        p( 889,  963),    p( 879,  978),    p( 883,  978),    p( 886,  991),    p( 890,  990),    p( 892,  990),    p( 901,  986),    p( 909,  977),
        p( 888,  948),    p( 893,  963),    p( 889,  976),    p( 886,  978),    p( 891,  987),    p( 898,  975),    p( 910,  963),    p( 909,  951),
        p( 886,  953),    p( 888,  958),    p( 895,  960),    p( 895,  974),    p( 896,  973),    p( 898,  956),    p( 909,  937),    p( 916,  913),
        p( 874,  953),    p( 885,  941),    p( 887,  953),    p( 895,  955),    p( 897,  944),    p( 884,  949),    p( 885,  943),    p( 891,  925),
    ],
    // king
    [
        p( 153,  -70),    p(  66,  -24),    p(  81,  -13),    p(  19,   13),    p(  40,    3),    p(  28,   15),    p(  85,    4),    p( 208,  -71),
        p( -34,   16),    p( -58,   30),    p( -61,   37),    p(   0,   27),    p( -31,   36),    p( -50,   50),    p( -27,   38),    p(   5,   18),
        p( -52,   22),    p( -40,   22),    p( -78,   34),    p( -87,   43),    p( -51,   39),    p( -17,   31),    p( -58,   34),    p( -28,   21),
        p( -27,    7),    p( -96,   15),    p(-112,   28),    p(-133,   37),    p(-132,   37),    p(-108,   30),    p(-120,   22),    p(-102,   22),
        p( -42,   -3),    p(-105,    4),    p(-122,   20),    p(-147,   33),    p(-144,   31),    p(-120,   19),    p(-135,   12),    p(-118,   14),
        p( -36,    0),    p( -82,   -1),    p(-110,   11),    p(-120,   21),    p(-117,   21),    p(-126,   14),    p(-102,    4),    p( -73,   10),
        p(  24,   -8),    p( -69,   -6),    p( -80,    1),    p( -99,   10),    p(-105,   13),    p( -92,    5),    p( -65,   -9),    p(   1,   -3),
...
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        ...
        p( -41,   41),    p( -47,   54),    p( -67,   57),    p( -69,   50),    p( -58,   37),    p( -48,   38),    p( -30,   44),    p( -47,   46),
...
const THREATS: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(-9, 7), p(0, 0), p(23, 20), p(49, -10), p(20, -31), p(0, 0)],
    [p(-2, 11), p(19, 21), p(0, 0), p(30, 5), p(30, 52), p(0, 0)],
    [p(-3, 14), p(10, 13), p(18, 8), p(0, 0), p(42, 3), p(0, 0)],
...
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    ...
    [p(2, 8), p(11, 20), p(-132, -18), p(8, 13), p(10, 20), p(3, 6)],
    [p(2, 3), p(12, 7), p(8, 12), p(11, 10), p(9, 27), p(20, -3)],
    [p(1, 1), p(8, 1), p(6, -4), p(4, 13), p(-76, -236), p(4, -9)],
    [p(60, -2), p(39, 9), p(44, 3), p(22, 6), p(34, -4), p(0, 0)],
];
...
const PIN: [PhasedScore; NUM_CHESS_PIECES - 1] = [p(5, -17), p(23, 30), p(15, 35), p(41, 23), p(67, 33)];
const DISCOVERED_CHECK: [PhasedScore; NUM_CHESS_PIECES] =
    [p(-7, -17), p(50, 39), p(148, -8), p(19, 72), p(0, 0), p(32, 3)];
const DISCOVERED_CHECK_STM: PhasedScore = p(247, 30);
