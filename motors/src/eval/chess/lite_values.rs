...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( -27,   22),    p( -21,   20),    p( -10,   10),    p( -13,   13),    p( -19,   11),    p(  24,   10),    p(  15,   31),    p(   6,   27),
        p( -40,   -1),    p( -31,   -5),    p( -34,  -13),    p( -12,   -7),    p(  -8,   -9),    p(  -9,  -18),    p(  -8,   -8),    p( -10,   -9),
        p( -48,  -14),    p( -44,  -11),    p( -24,  -11),    p( -11,   -9),    p(  -6,  -10),    p(  -7,  -12),    p( -17,  -16),    p( -23,  -20),
        p( -56,  -15),    p( -47,  -18),    p( -28,  -10),    p( -18,   -8),    p( -18,   -7),    p( -15,  -10),    p( -13,  -26),    p( -25,  -22),
        p( -47,   -7),    p( -40,  -10),    p( -35,  -11),    p( -37,   -6),    p( -32,   -3),    p(  -5,  -15),    p(   9,  -25),    p( -15,  -22),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
    ],
    // knight
    [
        p( -63,  -43),    p( -66,    8),    p( -67,   13),    p( -47,   14),    p(  -4,    0),    p( -64,    2),    p( -56,   -9),    p( -62,  -55),
        p( -19,    9),    p(  -6,   16),    p(   9,    4),    p(  12,    6),    p(  12,   -0),    p(  23,   -7),    p(   4,    5),    p( -14,   -4),
        p(  -5,    6),    p(  20,    1),    p(  27,    4),    p(  40,    4),    p(  44,    1),    p(  55,  -10),    p(   4,   -1),    p(   3,   -2),
        p(  11,   13),    p(  20,    8),    p(  37,   10),    p(  41,   15),    p(  38,   14),    p(  42,    9),    p(  26,   11),    p(  36,    4),
        p(   4,   13),    p(  17,    5),    p(  23,   11),    p(  31,   14),    p(  31,   15),    p(  34,    3),    p(  29,    2),    p(  19,   11),
        p( -20,   -0),    p( -10,   -2),    p(   1,   -4),    p(  10,    8),    p(  13,    6),    p(  12,  -13),    p(  10,   -8),    p(   3,    0),
        p( -27,    5),    p( -13,    8),    p(  -8,    3),    p(  -0,    5),    p(   8,    1),    p(   3,   -5),    p(   2,    4),    p(  -2,   12),
        p( -49,   -3),    p( -20,    3),    p( -28,    1),    p(  -7,    5),    p(  -2,    6),    p(   0,   -6),    p( -13,    5),    p( -22,    2),
    ],
    // bishop
    [
        p( -26,   17),    p( -35,    9),    p( -60,    5),    p( -55,   12),    p( -60,    8),    p( -52,    6),    p( -29,    8),    p( -39,    7),
        p( -15,    5),    p(  -9,    4),    p(   3,    2),    p( -11,    2),    p(  -3,   -3),    p(  -2,   -2),    p( -36,   12),    p( -23,    2),
        p(   2,    7),    p(   9,    3),    p(  -1,    5),    p(   8,   -5),    p(   4,    1),    p(  31,    1),    p(  20,    3),    p(  11,   12),
        p(  -5,    7),    p(   5,    2),    p(   9,   -1),    p(  12,    5),    p(  14,    1),    p(  14,    1),    p(  19,   -2),    p(  -2,    3),
        p(  -4,    3),    p(  -8,    4),    p(  -1,    3),    p(  12,    1),    p(   9,    1),    p(  11,   -6),    p(  -2,   -2),    p(  20,   -7),
        p(  -3,    3),    p(   2,    1),    p(   2,    4),    p(   2,    3),    p(   8,    2),    p(   4,   -3),    p(  12,   -9),    p(  13,   -2),
        p(   8,   -0),    p(   0,   -0),    p(   8,   -2),    p(   1,    5),    p(   3,    3),    p(  10,    1),    p(  18,   -5),    p(  13,   -1),
        p(   2,   -0),    p(  10,    1),    p(   3,    6),    p(  -6,    5),    p(   6,    5),    p(  -7,    8),    p(   4,    2),    p(  11,   -6),
    ],
    // rook
    [
        p( -37,   43),    p( -40,   45),    p( -50,   51),    p( -52,   49),    p( -43,   44),    p( -27,   46),    p( -36,   46),    p(  -8,   31),
        p( -22,   39),    p( -21,   41),    p( -12,   41),    p(   6,   32),    p(  -7,   34),    p(  18,   29),    p(  15,   29),    p(  15,   21),
        p( -26,   37),    p(  -6,   29),    p( -11,   32),    p(  -9,   25),    p(  15,   18),    p(  31,   14),    p(  33,   18),    p(   1,   20),
        p( -29,   36),    p( -20,   32),    p( -20,   34),    p( -13,   28),    p(  -8,   24),    p(   4,   22),    p(  -4,   25),    p( -10,   22),
        p( -41,   34),    p( -38,   32),    p( -36,   33),    p( -28,   29),    p( -23,   27),    p( -26,   27),    p( -11,   22),    p( -29,   22),
        p( -44,   29),    p( -38,   24),    p( -38,   26),    p( -35,   26),    p( -26,   19),    p( -18,   15),    p(  -5,    7),    p( -19,   12),
        p( -43,   26),    p( -36,   24),    p( -30,   24),    p( -25,   20),    p( -19,   16),    p(  -8,   10),    p(   1,    4),    p( -34,   18),
        p( -35,   30),    p( -36,   24),    p( -37,   28),    p( -32,   24),    p( -25,   18),    p( -23,   22),    p( -36,   27),    p( -39,   22),
    ],
    // queen
    [
        p( -24,   54),    p( -19,   52),    p(  -9,   60),    p(  13,   52),    p(  18,   52),    p(  42,   40),    p(  64,    4),    p(   9,   31),
        p(  12,   40),    p(  15,   42),    p(  24,   46),    p(  20,   61),    p(  18,   68),    p(  43,   53),    p(  30,   50),    p(  57,   27),
        p(  33,   31),    p(  33,   32),    p(  32,   48),    p(  31,   52),    p(  31,   56),    p(  53,   52),    p(  62,   35),    p(  46,   40),
        p(  19,   42),    p(  27,   45),    p(  24,   47),    p(  18,   59),    p(  26,   55),    p(  39,   50),    p(  39,   58),    p(  40,   47),
        p(  10,   49),    p(  12,   48),    p(  13,   50),    p(  14,   58),    p(  20,   57),    p(  26,   51),    p(  30,   50),    p(  32,   46),
        p(   9,   34),    p(  14,   37),    p(  11,   49),    p(  10,   53),    p(  13,   59),    p(  24,   43),    p(  29,   37),    p(  27,   25),
        p(  11,   25),    p(   8,   36),    p(  13,   40),    p(  13,   49),    p(  14,   49),    p(  17,   32),    p(  23,   14),    p(  15,   17),
        p(  -6,   34),    p(   3,   28),    p(   4,   36),    p(   8,   40),    p(  10,   34),    p(  -2,   36),    p(  -5,   16),    p(   4,    1),
    ],
    // king
    [
        ...
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p( -57,   18),    p( -39,    7),    p( -44,   -4),    p( -60,    0),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p( -45,    9),    p( -43,    2),    p( -23,  -10),    p( -35,    1),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p( -46,    3),    p( -35,   -3),    p( -12,  -16),    p(  10,   -7),
...
const BAD_BISHOP: [PhasedScore; 9] =
    [p(16, 19), p(17, 15), p(16, 5), p(11, -2), p(7, -9), p(2, -17), p(-5, -25), p(-12, -37), p(-23, -40)];
...
const BISHOP_OPENNESS: [[PhasedScore; 8]; 4] = [
    ...
    // Closed
    [p(0, 0), p(0, 0), p(12, -19), p(-17, 9), p(3, 7), p(2, 3), p(4, 4), p(3, 0)],
    // SemiOpen
    [p(0, 0), p(-8, 24), p(11, 15), p(0, 9), p(2, 8), p(6, 4), p(7, -1), p(13, 2)],
    // SemiClosed
    [p(0, 0), p(11, -13), p(11, 3), p(3, -1), p(8, -0), p(3, 2), p(8, 1), p(6, -1)],
];
...
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
        p( -23,   36),    p( -24,   52),    p( -34,   44),    p( -33,   27),    p( -34,   27),    p( -28,   26),    p( -16,   28),    p( -38,   31),
        p( -19,   33),    p( -31,   53),    p( -33,   43),    p( -31,   29),    p( -45,   36),    p( -41,   33),    p( -32,   40),    p( -33,   28),
        ...
        p(   9,   55),    p(  22,   49),    p(   8,   43),    p(  -4,   33),    p(   2,   43),    p(  -4,   56),    p( -17,   56),    p( -38,   61),
        p(  20,   53),    p(  22,   52),    p(  26,   47),    p(  28,   43),    p(  27,   47),    p(  30,   56),    p(   3,   61),    p(   7,   60),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
];
...
const PAWN_PROTECTION: [PhasedScore; NUM_CHESS_PIECES] =
    [p(15, 15), p(8, 17), p(13, 20), p(7, 10), p(-1, 10), p(-45, 13)];
const PAWN_ATTACKS: [PhasedScore; NUM_CHESS_PIECES] = [p(0, 0), p(49, 22), p(51, 43), p(59, 8), p(50, -3), p(0, 0)];
const PAWN_ADVANCE_THREAT: [PhasedScore; NUM_CHESS_PIECES] =
    [p(1, -5), p(14, 20), p(18, -7), p(15, 10), p(15, -8), p(30, -11)];
...
const THREATS: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(-5, 14), p(0, 0), p(25, 25), p(53, 9), p(37, -5), p(0, 0)],
    [p(-3, 12), p(18, 27), p(0, 0), p(40, 21), p(49, 63), p(0, 0)],
    [p(-9, 21), p(5, 21), p(12, 17), p(0, 0), p(50, 53), p(0, 0)],
    [p(-3, 16), p(-1, 20), p(-1, 29), p(-1, 16), p(0, 0), p(0, 0)],
    [p(51, 22), p(-11, 21), p(20, 14), p(-6, 14), p(0, 0), p(0, 0)],
];
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(0, 8), p(7, 8), p(5, 10), p(10, 8), p(6, 16), p(2, 7)],
    [p(2, 9), p(10, 22), p(-61, -31), p(7, 13), p(8, 22), p(2, 6)],
    [p(-3, 8), p(7, 13), p(4, 16), p(8, 12), p(3, 33), p(12, -4)],
    [p(0, 8), p(6, 11), p(5, 5), p(3, 19), p(-71, -68), p(1, -9)],
    [p(26, 3), p(14, 14), p(20, 9), p(7, 9), p(19, 2), p(0, 0)],
];
const KNIGHT_ATTACK_ON_QUEEN: PhasedScore = p(17, -7);
const KING_ZONE_ATTACK: [PhasedScore; 6] = [p(7, -19), p(10, -9), p(3, -4), p(13, -19), p(6, -4), p(16, -2)];
const CAN_GIVE_CHECK: [PhasedScore; 5] = [p(0, 0), p(4, -2), p(-9, 9), p(2, -8), p(-23, 14)];
...
const PIN: [PhasedScore; NUM_CHESS_PIECES - 1] = [p(13, -9), p(35, 37), p(30, 41), p(49, 19), p(59, 14)];
...
pub trait LiteValues: Debug + Default + Copy + Clone + Send + 'static + StaticallyNamedEntity {
    ...
    fn knight_attacks_on_queen() -> SingleFeatureScore<Self::Score>;
