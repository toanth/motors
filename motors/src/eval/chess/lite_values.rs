...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( 883,  955),    p( 891,  974),    p( 883,  989),    p( 880,  992),    p( 886, 1000),    p( 893,  990),    p( 907,  973),    p( 906,  957),
        p( 887,  953),    p( 884,  962),    p( 891,  966),    p( 890,  979),    p( 890,  979),    p( 893,  963),    p( 903,  940),    p( 913,  912),
    ...
    [
        ...
        p( -44,    5),    p( -38,   22),    p( -81,   40),    p( -87,   48),    p( -54,   42),    p( -22,   35),    p( -60,   33),    p( -32,   10),
        ...
        p( -37,   -1),    p( -88,   12),    p(-117,   27),    p(-126,   36),    p(-120,   35),    p(-134,   28),    p(-105,   14),    p( -75,    9),
...
const BISHOP_OPENNESS: [[PhasedScore; 8]; 4] = [
    ...
    // Closed
    [p(0, 0), p(0, 0), p(14, -34), p(-16, 9), p(-0, 13), p(2, 4), p(2, 10), p(-1, 6), ],
    // SemiOpen
...
const OUTPOSTS: [PhasedScore; 5] = [p(22, 16), p(29, -6), p(21, 16), p(16, 3), p(10, 10)];
