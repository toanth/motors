...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p(  19,   52),    p(  20,   51),    p(  24,   46),    p(  26,   41),    p(  25,   46),    p(  30,   56),    p(  -0,   60),    p(   6,   60),
        p( -29,   21),    p( -22,   19),    p( -11,    9),    p( -13,   12),    p( -18,    9),    p(  26,    9),    p(  17,   29),    p(   9,   26),
        p( -42,   -1),    p( -33,   -6),    p( -35,  -13),    p( -13,   -8),    p(  -9,  -10),    p(  -8,  -20),    p(  -6,   -9),    p(  -7,  -10),
        p( -49,  -14),    p( -45,  -12),    p( -25,  -12),    p( -11,   -9),    p(  -6,  -10),    p(  -6,  -13),    p( -15,  -16),    p( -19,  -21),
        p( -58,  -15),    p( -48,  -18),    p( -29,  -10),    p( -18,   -8),    p( -18,   -8),    p( -15,  -10),    p( -10,  -26),    p( -22,  -23),
        p( -47,   -8),    p( -41,  -10),    p( -35,  -12),    p( -37,   -7),    p( -31,   -4),    p(  -5,  -14),    p(  12,  -25),    p( -13,  -23),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
    ],
    // knight
    [
        p( -62,  -48),    p( -65,    1),    p( -66,    6),    p( -49,    7),    p(  -7,   -5),    p( -64,   -4),    p( -55,  -16),    p( -62,  -59),
        p( -19,    3),    p(  -7,    9),    p(   6,   -1),    p(   9,    2),    p(  13,   -4),    p(  23,  -12),    p(   2,    0),    p( -14,   -9),
        p(  -6,    1),    p(  12,   -4),    p(  16,    2),    p(  26,    3),    p(  37,   -0),    p(  54,  -11),    p(   2,   -4),    p(   2,   -5),
        p(  14,    6),    p(  21,    3),    p(  34,    6),    p(  34,   13),    p(  33,   11),    p(  35,    8),    p(  25,    8),    p(  36,   -2),
        p(   8,    5),    p(  19,   -1),    p(  21,    6),    p(  30,    8),    p(  28,   10),    p(  35,   -3),    p(  33,   -4),    p(  24,    3),
        p( -14,   -7),    p(  -7,   -7),    p(   1,   -9),    p(  10,    2),    p(  15,    0),    p(  13,  -19),    p(  13,  -14),    p(   8,   -6),
        p( -22,   -1),    p(  -8,    3),    p(  -6,   -3),    p(   3,   -1),    p(  11,   -5),    p(   5,  -10),    p(   9,   -1),    p(   4,    6),
        p( -44,   -8),    p( -13,   -4),    p( -22,   -5),    p(  -2,    0),    p(   4,    0),    p(   4,   -9),    p(  -6,   -2),    p( -21,   -3),
    ],
    // bishop
    [
        p( -24,   14),    p( -37,    7),    p( -62,    3),    p( -59,   10),    p( -64,    7),    p( -58,    4),    p( -38,    7),    p( -40,    4),
        p( -11,    1),    p( -11,    2),    p(   1,    1),    p( -14,    1),    p(  -6,   -4),    p(   2,   -3),    p( -39,   10),    p( -20,   -0),
        p(   1,    5),    p(  11,    1),    p(  -4,    4),    p(   8,   -6),    p(   7,    0),    p(  38,   -1),    p(  24,    1),    p(  17,   10),
        p(  -4,    5),    p(   4,    1),    p(  11,   -4),    p(  12,    4),    p(  12,    1),    p(  12,    0),    p(  17,   -3),    p(  -2,    1),
        p(  -2,    1),    p(  -7,    2),    p(  -2,    2),    p(  12,   -1),    p(   8,   -1),    p(  10,   -6),    p(  -3,   -2),    p(  23,  -10),
        p(  -3,    1),    p(   4,   -0),    p(   2,    2),    p(  -0,    2),    p(   8,    1),    p(   6,   -5),    p(  14,  -11),    p(  13,   -4),
        p(   9,   -2),    p(   0,   -2),    p(  11,   -4),    p(   3,    4),    p(   5,    2),    p(  12,   -0),    p(  18,   -7),    p(  12,   -3),
        p(   5,   -3),    p(  13,   -1),    p(   6,    4),    p(  -0,    3),    p(  13,    3),    p(  -6,    7),    p(   7,    1),    p(  10,   -8),
    ],
    // rook
    [
        p( -38,   43),    p( -41,   46),    p( -51,   52),    p( -52,   50),    p( -43,   46),    p( -25,   47),    p( -33,   49),    p(   0,   30),
        p( -31,   42),    p( -32,   45),    p( -25,   45),    p( -10,   37),    p( -22,   39),    p(   4,   35),    p(   6,   35),    p(  15,   23),
        p( -32,   38),    p( -14,   31),    p( -20,   33),    p( -21,   27),    p(   3,   20),    p(  20,   15),    p(  26,   20),    p(   1,   21),
        p( -34,   37),    p( -25,   32),    p( -25,   33),    p( -22,   29),    p( -16,   25),    p(  -0,   21),    p(  -5,   27),    p( -10,   23),
        p( -44,   34),    p( -41,   31),    p( -40,   32),    p( -33,   28),    p( -26,   26),    p( -28,   25),    p( -12,   22),    p( -28,   22),
        p( -48,   29),    p( -42,   24),    p( -42,   25),    p( -39,   25),    p( -29,   18),    p( -19,   13),    p(  -5,    7),    p( -20,   12),
        p( -47,   26),    p( -42,   24),    p( -34,   24),    p( -30,   20),    p( -23,   16),    p( -10,    8),    p(  -0,    4),    p( -36,   18),
        p( -40,   31),    p( -40,   25),    p( -41,   28),    p( -37,   23),    p( -30,   17),    p( -29,   21),    p( -41,   28),    p( -44,   22),
    ],
    // queen
    [
        p( -12,   59),    p( -10,   63),    p(   9,   66),    p(  29,   59),    p(  35,   62),    p(  53,   56),    p(  70,   25),    p(  23,   43),
        p(  21,   43),    p(  11,   51),    p(  12,   64),    p(  15,   71),    p(  24,   71),    p(  47,   65),    p(  37,   58),    p(  71,   43),
        p(  34,   40),    p(  30,   41),    p(  28,   58),    p(  27,   64),    p(  33,   67),    p(  66,   65),    p(  69,   54),    p(  61,   55),
        p(  22,   47),    p(  26,   50),    p(  25,   48),    p(  19,   63),    p(  25,   65),    p(  41,   61),    p(  44,   68),    p(  48,   55),
        p(  17,   48),    p(  16,   47),    p(  18,   46),    p(  20,   56),    p(  25,   58),    p(  28,   56),    p(  36,   57),    p(  38,   50),
        p(  18,   32),    p(  23,   36),    p(  18,   47),    p(  17,   50),    p(  21,   57),    p(  31,   44),    p(  38,   39),    p(  35,   28),
        p(  18,   29),    p(  17,   38),    p(  21,   39),    p(  21,   52),    p(  23,   53),    p(  27,   31),    p(  34,   18),    p(  24,   19),
        p(   2,   42),    p(  13,   31),    p(  13,   38),    p(  17,   44),    p(  19,   33),    p(   6,   40),    p(   1,   24),    p(  12,    4),
    ],
    // king
    [
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(  60,    9),    p(  67,    6),    p(  73,   -2),    p(  71,  -42),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(  56,   17),    p(  29,   26),    p(  35,   18),    p(  11,   11),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(  20,   26),    p(  35,   19),    p(  29,   13),    p( -14,   16),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p( -46,   24),    p( -30,   17),    p( -28,    5),    p( -47,   10),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p( -62,   19),    p( -46,    8),    p( -46,   -3),    p( -62,    2),
...
const BAD_BISHOP: [PhasedScore; 9] =
    [p(16, 14), p(17, 12), p(16, 2), p(11, -5), p(7, -11), p(3, -19), p(-4, -27), p(-10, -38), p(-21, -41)];
...
const BISHOP_OPENNESS: [[PhasedScore; 8]; 4] = [
    // Open
    [p(-4, -0), p(2, 2), p(3, -1), p(2, -0), p(5, 1), p(6, 2), p(12, -2), p(22, -5)],
    // Closed
    [p(0, 0), p(0, 0), p(16, -17), p(-17, 7), p(2, 6), p(2, 0), p(3, 2), p(3, -1)],
    // SemiOpen
    [p(0, 0), p(-4, 21), p(10, 13), p(-0, 7), p(2, 6), p(6, 2), p(6, -2), p(13, 0)],
    // SemiClosed
    [p(0, 0), p(13, -16), p(12, 0), p(2, -4), p(8, -2), p(3, -0), p(7, -1), p(5, -2)],
];
...
const PAWNLESS_FLANK: PhasedScore = p(-4, -35);
...
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
        p( -25,   35),    p( -27,   51),    p( -38,   44),    p( -40,   27),    p( -39,   27),    p( -29,   25),    p( -15,   27),    p( -40,   29),
        p( -19,   33),    p( -33,   53),    p( -35,   43),    p( -34,   29),    p( -48,   35),    p( -44,   33),    p( -34,   40),    p( -34,   28),
        p( -12,   44),    p( -20,   43),    p( -32,   43),    p( -27,   41),    p( -37,   45),    p( -32,   46),    p( -34,   53),    p( -55,   53),
        p(   0,   53),    p(  -2,   51),    p(   0,   42),    p( -12,   50),    p( -26,   57),    p( -18,   61),    p( -17,   64),    p( -39,   65),
        p(   7,   55),    p(  20,   49),    p(   7,   42),    p(  -5,   32),    p(  -1,   43),    p(  -7,   56),    p( -20,   57),    p( -41,   61),
        p(  19,   52),    p(  20,   51),    p(  24,   46),    p(  26,   41),    p(  25,   46),    p(  30,   56),    p(  -0,   60),    p(   6,   60),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
];
...
const PAWN_PROTECTION: [PhasedScore; NUM_CHESS_PIECES] =
    [p(15, 14), p(7, 17), p(14, 19), p(6, 10), p(-3, 11), p(-47, 12)];
const PAWN_ATTACKS: [PhasedScore; NUM_CHESS_PIECES] = [p(0, 0), p(48, 20), p(50, 43), p(58, 9), p(49, -6), p(0, 0)];
const PAWN_ADVANCE_THREAT: [PhasedScore; NUM_CHESS_PIECES] =
    [p(0, -4), p(14, 20), p(18, -7), p(15, 10), p(17, -12), p(30, -12)];
...
const THREATS: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    ...
    [p(-6, 19), p(9, 19), p(16, 16), p(0, 0), p(59, 51), p(0, 0)],
    [p(-4, 16), p(-0, 18), p(-1, 31), p(-4, 23), p(0, 0), p(0, 0)],
    [p(50, 22), p(-22, 23), p(3, 17), p(-14, 23), p(0, 0), p(0, 0)],
];
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(2, 8), p(8, 6), p(6, 10), p(12, 6), p(8, 16), p(3, 7)],
    [p(3, 8), p(11, 20), p(-50, -30), p(9, 11), p(10, 18), p(5, 5)],
    [p(-3, 8), p(9, 11), p(4, 16), p(7, 12), p(4, 33), p(15, -1)],
    [p(-0, 10), p(6, 12), p(5, 7), p(3, 18), p(-70, -68), p(2, -2)],
    [p(24, 5), p(13, 16), p(18, 10), p(3, 10), p(15, -4), p(0, 0)],
];
const KING_ZONE_ATTACK: [PhasedScore; 6] = [p(7, -19), p(18, -9), p(9, -3), p(15, -16), p(-5, 9), p(8, -0)];
const CAN_GIVE_CHECK: [PhasedScore; 5] = [p(0, 0), p(9, 1), p(-5, 7), p(14, -6), p(-11, 32)];
...
const DISCOVERED_CHECK: [PhasedScore; NUM_CHESS_PIECES] =
    [p(10, -5), p(63, 26), p(66, 11), p(66, 67), p(0, 0), p(25, -23)];
const PIN: [PhasedScore; NUM_CHESS_PIECES - 1] = [p(5, -16), p(26, 28), p(17, 31), p(41, 10), p(54, 12)];
