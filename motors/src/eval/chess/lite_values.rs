...
const BAD_BISHOP: [PhasedScore; 9] = [p(13, 21), p(13, 18), p(13, 8), p(9, 1), p(4, -6), p(0, -15), p(-6, -23), p(-12, -36), p(-23, -40)];
...
[p(22, 8), p(4, 3), p(2, 5), p(-7, 7), p(6, 3), p(-7, -9), p(-3, 1), p(-4, -8), p(1, -2), p(-10, -2), p(-7, -15), p(-15, -5), p(6, -5), p(-1, -8), p(7, -3), p(6, 17), p(-6, -2), p(-22, -4), p(-13, 2), p(-38, 23), p(-20, 5), p(-19, -16), p(3, 28), p(-45, 30), p(-18, -16), p(-21, -14), p(-34, -27), p(-39, 16), p(-17, 2), p(13, -2), p(-84, 100), p(0, 0), p(1, -5), p(-13, -6), p(-2, -5), p(-21, 1), p(-21, -1), p(-44, -18), p(-26, 39), p(-32, 30), p(-6, -5), p(-19, -9), p(7, -9), p(-16, 36), p(-48, 21), p(-0, -27), p(0, 0), p(0, 0), p(-4, -11), p(-16, 8), p(-7, -52), p(0, 0), p(6, -8), p(-37, -12), p(0, 0), p(0, 0), p(-29, -4), p(-23, -10), p(-19, 21), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0)];
const PAWN_PASSIVE_CENTER: [PhasedScore; NUM_PAWN_CENTER_CONFIGURATIONS] =
[p(25, 5), p(4, -1), p(-5, 4), p(-21, -0), p(11, -4), p(-23, -8), p(-15, -0), p(-34, -9), p(8, -2), p(-9, -8), p(-28, -5), p(-43, 1), p(-1, -5), p(-37, -5), p(-31, -6), p(-47, 61), p(10, 0), p(-0, -7), p(-4, -8), p(-21, -1), p(-9, -1), p(-14, -11), p(-22, 1), p(-66, 180), p(-4, -10), p(-24, -14), p(-31, -26), p(11, -79), p(-11, -8), p(-10, -18), p(-77, 70), p(0, 0), p(12, 0), p(-2, -3), p(-17, -5), p(-26, -5), p(0, 1), p(-25, -15), p(-15, -0), p(-27, 3), p(-1, -7), p(-21, -7), p(-27, -12), p(-36, -3), p(-6, -1), p(-45, -5), p(4, 17), p(-57, 62), p(4, 1), p(-11, -1), p(-28, 60), p(0, 0), p(-13, -2), p(-19, 7), p(0, 0), p(0, 0), p(-13, 2), p(-38, 10), p(-31, -39), p(0, 0), p(18, -60), p(0, 0), p(0, 0), p(0, 0)];
const PAWN_SHIELDS: [PhasedScore; NUM_PAWN_SHIELD_CONFIGURATIONS] = [
p(-13, 9) /*0b0000*/, p(-13, 7) /*0b0001*/, p(-5, 11) /*0b0010*/, p(-4, 10) /*0b0011*/, p(-9, 3) /*0b0100*/, p(-24, -1) /*0b0101*/, p(-11, 4) /*0b0110*/, p(-13, -11) /*0b0111*/, p(0, 5) /*0b1000*/, p(-9, 9) /*0b1001*/, p(-2, 10) /*0b1010*/, p(2, 11) /*0b1011*/, p(-5, 3) /*0b1100*/, p(-19, 3) /*0b1101*/, p(-10, 3) /*0b1110*/, p(0, 0) /*0b1111*/, p(1, 9) /*0b10000*/, p(3, 6) /*0b10001*/, p(19, 7) /*0b10010*/, p(-2, 6) /*0b10011*/, p(-9, 3) /*0b10100*/, p(11, 12) /*0b10101*/, p(-30, 2) /*0b10110*/, p(0, 0) /*0b10111*/, p(7, 10) /*0b11000*/, p(24, 11) /*0b11001*/, p(26, 25) /*0b11010*/, p(0, 0) /*0b11011*/, p(6, -3) /*0b11100*/, p(0, 0) /*0b11101*/, p(0, 0) /*0b11110*/, p(0, 0) /*0b11111*/, p(6, 3) /*0b100000*/, p(-1, 7) /*0b100001*/, p(13, 3) /*0b100010*/, p(5, -1) /*0b100011*/, p(-6, -3) /*0b100100*/, p(-21, -13) /*0b100101*/, p(-21, 18) /*0b100110*/, p(0, 0) /*0b100111*/, p(15, -2) /*0b101000*/, p(-1, 8) /*0b101001*/, p(9, -5) /*0b101010*/, p(0, 0) /*0b101011*/, p(-1, -1) /*0b101100*/, p(0, 0) /*0b101101*/, p(0, 0) /*0b101110*/, p(0, 0) /*0b101111*/, p(2, 2) /*0b110000*/, p(12, 4) /*0b110001*/, p(14, -5) /*0b110010*/, p(0, 0) /*0b110011*/, p(9, 13) /*0b110100*/, p(0, 0) /*0b110101*/, p(0, 0) /*0b110110*/, p(0, 0) /*0b110111*/, p(18, -6) /*0b111000*/, p(0, 0) /*0b111001*/, p(0, 0) /*0b111010*/, p(0, 0) /*0b111011*/, p(0, 0) /*0b111100*/, p(0, 0) /*0b111101*/, p(0, 0) /*0b111110*/, p(3, -5) /*0b111111*/, p(13, -1) /*0b00*/, p(21, -11) /*0b01*/, p(37, -10) /*0b10*/, p(12, -31) /*0b11*/, p(41, -5) /*0b100*/, p(13, -10) /*0b101*/, p(49, -30) /*0b110*/, p(0, 0) /*0b111*/, p(56, -13) /*0b1000*/, p(11, -20) /*0b1001*/, p(29, -37) /*0b1010*/, p(0, 0) /*0b1011*/, p(21, -20) /*0b1100*/, p(0, 0) /*0b1101*/, p(0, 0) /*0b1110*/, p(-18, 25) /*0b1111*/, p(21, 0) /*0b00*/, p(31, -12) /*0b01*/, p(28, -15) /*0b10*/, p(26, -39) /*0b11*/, p(31, -12) /*0b100*/, p(43, -20) /*0b101*/, p(19, -20) /*0b110*/, p(0, 0) /*0b111*/, p(34, -4) /*0b1000*/, p(41, -16) /*0b1001*/, p(46, -45) /*0b1010*/, p(0, 0) /*0b1011*/, p(28, -26) /*0b1100*/, p(0, 0) /*0b1101*/, p(0, 0) /*0b1110*/, p(13, -44) /*0b1111*/, ];
const PAWNLESS_FLANK: PhasedScore = p(-1, -37);
const STOPPABLE_PASSER: PhasedScore =
p(25, -48);
const CLOSE_KING_PASSER: PhasedScore =
p(3, 24);
...
const CANDIDATE_PASSER: [PhasedScore; 6] =
[p(1, 4), p(5, 8), p(8, 17), p(15, 22), p(17, 71), p(13, 64)];
...
const PAWN_PROTECTION: [PhasedScore; NUM_CHESS_PIECES] = [p(17, 14), p(7, 18), p(14, 21), p(7, 10), p(-3, 13), p(-48, 12)];
const PAWN_ATTACKS: [PhasedScore; NUM_CHESS_PIECES] = [p(0, 0), p(48, 21), p(51, 45), p(66, 4), p(51, -8), p(0, 0)];
const PAWN_ADVANCE_THREAT: [PhasedScore; NUM_CHESS_PIECES] = [p(1, -5), p(14, 20), p(19, -7), p(16, 10), p(16, -9), p(29, -12)];

pub const MAX_MOBILITY: usize = 7 + 7 + 7 + 6;
const MOBILITY: [[PhasedScore; MAX_MOBILITY + 1]; NUM_CHESS_PIECES - 1] = [
[p(-41, -67), p(-20, -27), p(-8, -4), p(1, 10), p(9, 20), p(16, 31), p(24, 34), p(30, 36), p(34, 35), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0)],
[p(-31, -56), p(-18, -37), p(-6, -21), p(1, -9), p(8, 1), p(13, 10), p(18, 15), p(23, 19), p(25, 25), p(32, 26), p(38, 26), p(43, 30), p(38, 41), p(51, 32), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0)],
[p(-68, 14), p(-59, 28), p(-55, 35), p(-51, 39), p(-52, 46), p(-46, 53), p(-44, 58), p(-40, 62), p(-37, 67), p(-34, 71), p(-29, 74), p(-28, 79), p(-21, 81), p(-12, 79), p(-8, 76), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0)],
[p(-19, -32), p(-19, 1), p(-24, 58), p(-19, 74), p(-18, 93), p(-13, 98), p(-10, 110), p(-6, 116), p(-3, 122), p(1, 124), p(4, 128), p(8, 131), p(11, 132), p(13, 137), p(16, 139), p(20, 142), p(22, 148), p(26, 149), p(36, 146), p(51, 139), p(57, 139), p(99, 117), p(98, 120), p(127, 97), p(216, 66), p(257, 28), p(289, 16), p(271, 12)],
[p(-89, -0), p(-59, -10), p(-31, -9), p(-2, -5), p(28, -3), p(51, -1), p(80, 5), p(105, 8), p(152, -1), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0), p(0, 0)],
];
...
const DISCOVERED_CHECK: [PhasedScore; NUM_CHESS_PIECES] = [p(11, -7), p(62, 1), p(101, -33), p(55, 89), p(0, 0), p(-26, -23)];
