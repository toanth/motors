...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( 125,  161),    p( 121,  159),    p( 114,  163),    p( 123,  147),    p( 110,  152),    p( 109,  155),    p(  67,  172),    p(  72,  171),
        p(  69,  117),    p(  67,  119),    p(  73,  112),    p(  80,  108),    p(  67,  102),    p( 121,  103),    p(  93,  121),    p(  93,  115),
        p(  53,  105),    p(  59,   98),    p(  56,   92),    p(  81,   96),    p(  88,   95),    p(  78,   82),    p(  73,   93),    p(  70,   89),
        p(  47,   92),    p(  48,   94),    p(  73,   90),    p(  93,   92),    p(  85,   95),    p(  80,   90),    p(  64,   85),    p(  57,   79),
        p(  40,   90),    p(  46,   86),    p(  68,   91),    p(  78,   93),    p(  80,   92),    p(  74,   90),    p(  64,   77),    p(  49,   79),
        p(  51,   94),    p(  55,   92),    p(  58,   92),    p(  53,   98),    p(  57,  100),    p(  73,   92),    p(  77,   82),    p(  56,   84),
        p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),    p( 100,  100),
    ],
    // knight
    [
        p( 171,  279),    p( 190,  313),    p( 208,  324),    p( 245,  312),    p( 275,  315),    p( 192,  308),    p( 212,  308),    p( 199,  263),
        p( 266,  312),    p( 282,  317),    p( 295,  310),    p( 299,  313),    p( 298,  309),    p( 307,  298),    p( 270,  316),    p( 273,  304),
        p( 285,  309),    p( 304,  306),    p( 303,  312),    p( 314,  314),    p( 330,  309),    p( 346,  298),    p( 288,  306),    p( 283,  307),
        p( 303,  316),    p( 312,  312),    p( 326,  314),    p( 326,  321),    p( 323,  321),    p( 323,  320),    p( 315,  318),    p( 322,  310),
        p( 299,  317),    p( 305,  309),    p( 313,  315),    p( 321,  317),    p( 319,  321),    p( 326,  307),    p( 324,  307),    p( 314,  314),
        p( 277,  303),    p( 283,  304),    p( 298,  299),    p( 301,  312),    p( 306,  310),    p( 297,  293),    p( 303,  295),    p( 294,  308),
        p( 270,  310),    p( 281,  314),    p( 285,  306),    p( 295,  310),    p( 299,  306),    p( 291,  304),    p( 295,  308),    p( 289,  319),
        p( 241,  307),    p( 282,  305),    p( 268,  308),    p( 288,  312),    p( 297,  310),    p( 292,  301),    p( 288,  309),    p( 264,  306),
    ],
    // bishop
    [
        p( 274,  313),    p( 247,  317),    p( 235,  309),    p( 219,  318),    p( 211,  317),    p( 225,  309),    p( 271,  306),    p( 251,  311),
        p( 281,  304),    p( 276,  306),    p( 288,  308),    p( 273,  306),    p( 285,  303),    p( 289,  302),    p( 262,  311),    p( 272,  304),
        ...
        p( 288,  306),    p( 287,  307),    p( 297,  304),    p( 310,  304),    p( 302,  300),    p( 305,  300),    p( 288,  304),    p( 312,  299),
        ...
        p( 298,  305),    p( 309,  306),    p( 307,  308),    p( 289,  312),    p( 305,  310),    p( 293,  312),    p( 302,  300),    p( 301,  293),
    ],
    // rook
    [
        p( 450,  550),    p( 436,  561),    p( 426,  568),    p( 427,  564),    p( 440,  560),    p( 467,  554),    p( 472,  555),    p( 483,  548),
        p( 443,  555),    p( 440,  561),    p( 449,  562),    p( 463,  553),    p( 449,  555),    p( 464,  550),    p( 472,  547),    p( 490,  536),
        p( 443,  551),    p( 462,  546),    p( 456,  548),    p( 456,  542),    p( 481,  532),    p( 492,  529),    p( 507,  529),    p( 483,  531),
        p( 443,  551),    p( 452,  546),    p( 453,  548),    p( 453,  543),    p( 460,  536),    p( 475,  530),    p( 475,  536),    p( 470,  531),
        p( 435,  548),    p( 437,  547),    p( 438,  547),    p( 444,  543),    p( 448,  540),    p( 446,  540),    p( 458,  535),    p( 451,  531),
        p( 431,  545),    p( 432,  543),    p( 435,  542),    p( 437,  541),    p( 443,  535),    p( 454,  528),    p( 470,  518),    p( 455,  521),
        p( 432,  541),    p( 437,  540),    p( 443,  540),    p( 446,  537),    p( 452,  531),    p( 467,  521),    p( 474,  518),    p( 443,  527),
        p( 442,  545),    p( 439,  540),    p( 440,  544),    p( 445,  537),    p( 450,  531),    p( 456,  531),    p( 452,  532),    p( 448,  534),
    ],
    // queen
    [
        p( 865,  968),    p( 867,  982),    p( 880,  995),    p( 902,  988),    p( 902,  992),    p( 928,  979),    p( 966,  937),    p( 914,  966),
        p( 889,  953),    p( 865,  981),    p( 865, 1008),    p( 857, 1026),    p( 865, 1037),    p( 902, 1001),    p( 907,  983),    p( 947,  965),
        p( 893,  960),    p( 887,  973),    p( 885,  994),    p( 886, 1004),    p( 897, 1012),    p( 945,  992),    p( 949,  968),    p( 940,  974),
        p( 885,  968),    p( 892,  974),    p( 887,  982),    p( 879,  999),    p( 886, 1009),    p( 906,  995),    p( 914, 1001),    p( 919,  980),
        p( 891,  962),    p( 883,  976),    p( 885,  979),    p( 887,  991),    p( 890,  992),    p( 896,  989),    p( 905,  985),    p( 913,  976),
        p( 888,  948),    p( 894,  964),    p( 890,  976),    p( 886,  979),    p( 892,  987),    p( 899,  975),    p( 911,  963),    p( 908,  952),
        p( 886,  952),    p( 887,  960),    p( 894,  961),    p( 894,  975),    p( 896,  974),    p( 897,  957),    p( 908,  939),    p( 915,  912),
        p( 873,  953),    p( 885,  942),    p( 886,  954),    p( 894,  955),    p( 896,  945),    p( 883,  949),    p( 884,  944),    p( 891,  924),
    ],
    // king
    [
        p( 158,  -65),    p(  66,  -14),    p(  95,   -5),    p(  23,   15),    p(  37,    5),    p(  13,   17),    p(  79,    4),    p( 201,  -66),
        p( -21,   17),    p( -45,   31),    p( -49,   39),    p(  10,   24),    p( -20,   33),    p( -46,   46),    p( -25,   35),    p(   7,   18),
        p( -45,   23),    p( -28,   23),    p( -69,   37),    p( -78,   43),    p( -44,   39),    p( -15,   31),    p( -54,   33),    p( -26,   22),
        p( -23,    9),    p( -86,   18),    p(-101,   32),    p(-128,   38),    p(-125,   38),    p(-105,   30),    p(-114,   21),    p(-102,   23),
        p( -42,   -0),    p(-101,    7),    p(-115,   23),    p(-142,   33),    p(-140,   32),    p(-114,   18),    p(-129,   11),    p(-117,   15),
        p( -37,    3),    p( -80,    0),    p(-106,   13),    p(-115,   19),    p(-112,   20),    p(-121,   14),    p( -97,    2),    p( -72,   11),
        p(  24,   -6),    p( -66,   -5),    p( -77,    1),    p( -95,    8),    p(-102,   11),    p( -88,    3),    p( -61,  -11),    p(   1,   -3),
        p(  45,  -17),    p(  40,  -30),    p(  37,  -19),    p( -23,   -3),    p(  28,  -18),    p( -20,   -4),    p(  32,  -25),    p(  57,  -30),
    ],
];

const BISHOP_PAIR: PhasedScore = p(24, 51);
const BAD_BISHOP: [PhasedScore; 9] =
    [p(10, 21), p(11, 18), p(11, 7), p(6, 0), p(2, -7), p(-1, -16), p(-7, -24), p(-14, -37), p(-24, -43)];
...
const PASSED_PAWNS: [PhasedScore; NUM_SQUARES] = [
        ...
        p( -26,   55),    p( -32,   57),    p( -58,   62),    p( -56,   62),    p( -63,   59),    p( -52,   59),    p( -58,   70),    p( -59,   67),
        p( -15,   72),    p( -17,   75),    p( -17,   66),    p( -40,   75),    p( -57,   76),    p( -45,   75),    p( -52,   84),    p( -59,   86),
        p(   3,   71),    p(   8,   70),    p(   2,   54),    p( -18,   40),    p( -14,   52),    p( -37,   58),    p( -45,   60),    p( -82,   81),
        p(  25,   61),    p(  21,   59),    p(  14,   63),    p(  23,   47),    p(  10,   52),    p(   9,   55),    p( -33,   72),    p( -28,   71),
        p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),    p(   0,    0),
];
const CANDIDATE_PASSER: [PhasedScore; 6] = [p(1, 4), p(5, 8), p(8, 17), p(16, 22), p(16, 68), p(11, 60)];
...
const PAWN_ATTACKS: [PhasedScore; NUM_CHESS_PIECES] = [p(0, 0), p(40, 10), p(42, 32), p(54, -11), p(38, -42), p(0, 0)];
const PAWN_ADVANCE_THREAT: [PhasedScore; NUM_CHESS_PIECES] =
    [p(0, -5), p(14, 20), p(18, -7), p(16, 9), p(17, -10), p(26, -11)];
...
const THREATS: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    ...
    [p(-2, 10), p(19, 21), p(0, 0), p(31, 5), p(30, 52), p(0, 0)],
    [p(-3, 14), p(10, 13), p(17, 9), p(0, 0), p(42, 3), p(0, 0)],
    [p(-2, 5), p(2, 4), p(-0, 17), p(0, -1), p(0, 0), p(0, 0)],
    [p(57, 19), p(-28, 19), p(5, 14), p(-19, 9), p(0, 0), p(0, 0)],
];
const DEFENDED: [[PhasedScore; NUM_CHESS_PIECES]; NUM_CHESS_PIECES - 1] = [
    [p(1, 7), p(8, 6), p(6, 10), p(12, 6), p(6, 17), p(10, 5)],
    [p(2, 8), p(11, 20), p(-117, -24), p(8, 13), p(10, 20), p(3, 6)],
    [p(2, 3), p(12, 6), p(9, 12), p(11, 9), p(9, 26), p(20, -4)],
    [p(2, 1), p(8, 1), p(6, -4), p(4, 13), p(-77, -238), p(4, -9)],
    [p(59, -2), p(38, 10), p(42, 4), p(21, 7), p(32, -3), p(0, 0)],
];
...
const PIN: [PhasedScore; NUM_CHESS_PIECES - 1] = [p(5, -17), p(23, 30), p(15, 36), p(40, 23), p(68, 32)];
const DISCOVERED_CHECK: [PhasedScore; NUM_CHESS_PIECES] =
    [p(-7, -18), p(105, 36), p(149, -8), p(57, 145), p(0, 0), p(35, 13)];
