...
const PSQTS: [[PhasedScore; NUM_SQUARES]; NUM_CHESS_PIECES] = [
    ...
    [
        ...
        p( 885,  949),    p( 892,  965),    p( 886,  979),    p( 884,  981),    p( 889,  988),    p( 895,  977),    p( 909,  961),    p( 907,  949),
    ...
    [
        ...
        p( -30,    2),    p( -81,   20),    p( -82,   27),    p( -22,   17),    p( -52,   24),    p( -81,   39),    p( -50,   25),    p(   9,    0),
        p( -46,   10),    p( -48,   14),    p( -86,   29),    p( -96,   37),    p( -64,   32),    p( -32,   24),    p( -78,   26),    p( -37,   11),
